package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1024:LoaderContext;
      
      protected var var_44:Array;
      
      protected var var_483:Array;
      
      private var var_573:uint = 0;
      
      protected var var_344:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_44 = new Array();
         var_483 = new Array();
         var_1024 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_344 = new AssetLibrary("lib-" + var_573++);
         var_44.push(var_344);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_344.createAsset(param1,param2);
      }
      ...
      private function getNumAssets() : uint
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ += IAssetLibrary(var_44[_loc3_]).numAssets;
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_344.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc4_ = var_44[_loc6_];
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_483.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
            (var_44.pop() as IAssetLibrary).dispose();
         }
      }
      ...
      {
         return var_344.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_344.loadAssetFromFile(param1,param2,param3);
      }
      ...
      public function getAssetByIndex(param1:uint) : IAsset
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc2_ += IAssetLibrary(var_44[_loc5_]).numAssets;
            if(_loc2_ <= param1)
            {
               return IAssetLibrary(var_44[_loc5_]).getAssetByIndex(param1 - _loc3_);
            }
            _loc3_ = uint(_loc2_);
            _loc5_++;
         }
      ...
      {
         return var_344.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_344.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_573++);
         var_483.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_483.length)
            {
               _loc3_ = var_483[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_483.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_344.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_344.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_344.loadFromArchive(param1,param2);
      }
      
      public function addAssetLibrary(param1:IAssetLibrary) : void
      {
         if(var_44.indexOf(param1) == -1)
         {
            var_44.push(param1);
         }
      }
      ...
      private function getAssetNameArray() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_ = _loc1_.concat(IAssetLibrary(var_44[_loc3_]).nameArray);
            _loc3_++;
         }
         return _loc1_;
      }
