package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_987:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_556:uint = 0;
      
      public static const const_1203:String = "AssetLibraryReady";
      
      public static const const_1160:String = "AssetLibraryUnloaded";
      
      public static const const_468:String = "AssetLibraryLoaded";
      
      public static const const_1229:String = "AssetLibraryLoadError";
       
      
      private var var_476:XML;
      ...
      private var var_1:LibraryLoader;
      ...
      private var var_475:Boolean = true;
      
      private var var_339:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_556;
         var_395 = new Dictionary(false);
         var_396 = new Dictionary(false);
         var_666 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_395)
         {
            _loc4_ = AssetTypeDeclaration(var_395[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_396)
         {
            _loc2_ = var_396[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_396[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_666)
         {
            delete var_666[_loc1_];
         }
         if(var_1 != null)
         {
            var_1.dispose();
         ...
         var_297 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1160));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_476 = _loc2_.manifest.copy();
         var_339 = _loc2_.resource;
         if(var_475)
         {
            AssetLibrary.fetchLibraryContents(this,var_476,var_339);
         }
         var_297 = true;
         dispatchEvent(new Event(AssetLibrary.const_468));
         if(var_475)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_396[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_30,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_45,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_934,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_974,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_946,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_986,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_396[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_395.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_395[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_987.splice(var_987.indexOf(this),1);
            --var_556;
            var_396 = null;
            var_666 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_338.length ? getAssetByName(var_338[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1229));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_395)
         {
            _loc3_ = AssetTypeDeclaration(var_395[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_666[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(var_1 != null)
         {
            if(var_1.hasDefinition(param1))
            {
               _loc2_ = var_1.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  var_666[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         if(_file == param1.url && var_297)
         {
            ...
            var_475 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1203));
         }
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_862);
               var_1.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,libraryLoadedHandler);
               var_1.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            }
            var_475 = param2;
            _file = param1.url;
            var_1.load(param1,param3);
         }
         return var_1;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_476.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_339[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_396[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_338.splice(var_338.indexOf(_loc2_),1);
      ...
      public function loadFromArchive(param1:URLRequest, param2:LoaderContext = null) : LibraryLoader
      {
         if(!(_file == param1.url && var_297))
         {
            ...
            var_1 = new ZipLoader(var_862);
            var_1.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,archiveLoadedHandler);
            var_1.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,loadErrorHandler);
            var_1.addEventListener(ProgressEvent.PROGRESS,onLoadProgress);
            var_475 = true;
            _file = param1.url;
            var_1.load(param1,param2);
         }
         return var_1;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_395[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_339 != null ? false : false;
      }
   }
}
