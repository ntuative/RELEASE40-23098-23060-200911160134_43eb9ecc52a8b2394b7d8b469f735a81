package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1240.push(var_1.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_836;
         if(var_1240.length == var_2040)
         {
         ...
         {
            var_1.loadBytes(var_561.getFileAt(var_836).content);
         }
      }
