package com.sulake.core.window.components
{
   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_469)
         {
            _offsetX = x != 0 ? Number(x / Number(0 - width)) : Number(0);
            var_705 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_23 != _scrollBar)
            {
               _scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_222,this,null));
            }
         }
