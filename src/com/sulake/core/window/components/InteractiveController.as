package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2126:uint = 0;
      
      protected var var_855:String = "";
      
      protected var var_410:Array;
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_410 = new Array();
         var_410[0] = MouseCursorType.const_313;
         var_410[1] = MouseCursorType.const_38;
         var_410[2] = MouseCursorType.const_313;
         var_410[3] = MouseCursorType.const_313;
         var_410[4] = MouseCursorType.const_38;
         var_410[5] = MouseCursorType.const_38;
         var_410[6] = MouseCursorType.const_313;
         if(var_308 == null)
         {
            var_308 = new Array();
            var_308[0] = WindowState.const_83;
            var_308[1] = WindowState.const_70;
            var_308[2] = WindowState.const_73;
            var_308[3] = WindowState.const_60;
            var_308[4] = WindowState.const_44;
            var_308[5] = WindowState.const_82;
            var_308[6] = WindowState.const_65;
         }
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            switch(_loc4_.key)
            {
               ...
               case "mouse_cursor_disabled":
                  param1.setMouseCursorByState(WindowState.const_65,_loc4_.value as uint);
                  break;
            }
            _loc5_++;
         }
