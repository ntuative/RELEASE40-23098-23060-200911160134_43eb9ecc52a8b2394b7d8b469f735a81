package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_315:IScrollbarWindow;
      
      private var var_1366:Boolean = true;
      
      public function ScrollableItemListWindow(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         _scrollBar.scrollable = _itemList;
         if(_scrollBar.testStateFlag(WindowState.const_65))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_315)
         {
            var_315 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_315)
            {
               var_315.addEventListener(WindowEvent.const_256,scrollBarEventProc);
               var_315.addEventListener(WindowEvent.const_201,scrollBarEventProc);
            }
         }
         return var_315;
      }
      ...
      override public function dispose() : void
      {
         if(var_315)
         {
            var_315.removeEventListener(WindowEvent.const_256,scrollBarEventProc);
            var_315.removeEventListener(WindowEvent.const_201,scrollBarEventProc);
            var_315 = null;
         }
         if(_cachedItemList)
         {
      ...
      {
         if(param1.type == WindowEvent.const_256)
         {
            showScrollBar();
         }
         else if(param1.type == WindowEvent.const_201)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!_cachedItemList)
         {
            _cachedItemList = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
