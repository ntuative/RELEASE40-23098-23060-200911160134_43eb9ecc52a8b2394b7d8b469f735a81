package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_327:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_129 = context.create(name + "::submenu","",WindowType.const_372,var_86,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_98)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_73))
               {
         ...
         else if(param1.type == WindowEvent.const_940)
         {
            if(param2 == var_129)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_344,var_86,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_321,var_86,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_434 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_434).setStateFlag(WindowState.const_44,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_508)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_433,getSubMenu(),subMenuEventProc);
                  var_508 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_459,this,null,true);
         update(this,_loc2_);
      ...
      {
         return getChildByName(DropMenuController.const_327) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_508 = false;
            getTitleText().text = var_434 < var_433.length && var_434 > -1 ? "null" : caption;
         }
      }
   }
}
