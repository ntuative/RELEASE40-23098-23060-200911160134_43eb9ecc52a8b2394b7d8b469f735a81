package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2200:Rectangle = new Rectangle();
       
      
      protected var var_206:Boolean;
      
      protected var var_72:TextMargins;
      
      protected var var_484:String = "none";
      
      protected var var_570:Number;
      
      protected var var_347:Number;
      
      protected var _field:TextField;
      
      protected var var_687:Boolean = false;
      
      public function TextController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         var_72 = new TextMargins(0,0,0,0,setTextMargins);
         var_206 = false;
         var_570 = 0;
         var_347 = 0;
         if(_field == null)
         {
            ...
            _field.width = param7.width;
            _field.height = param7.height;
      ...
      {
         param1.var_72.dispose();
         param1.var_72 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_570 * maxScrollH,var_347 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_687)
         {
            context.removeLocalizationListener(var_235,this);
         }
         if(var_72 != null)
         {
            var_72.dispose();
      ...
      {
         var_570 = param1;
         _field.scrollH = var_570 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_235 = param1;
         if(var_235.charAt(0) == "$" && var_235.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_235.slice(2,var_235.indexOf("}")),this);
            var_687 = true;
         }
         else if(_field != null)
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc5_ < _loc2_)
         {
            _loc3_ = param1[_loc5_] as PropertyStruct;
            _loc4_ = _PROPERTY_SETTER_TABLE[_loc3_.key];
            if(_loc4_ != null)
            {
               _loc4_(this,_loc3_.value);
            }
            _loc5_++;
         }
         var_206 = false;
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_72.dispose();
            var_72 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_229,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1259,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_412,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_229,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_59,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_412,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_229,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_84,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_654,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_229,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_654,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_59,true));
         _loc1_.push(new PropertyStruct("margin_left",var_72.left,PropertyStruct.const_84,true));
         _loc1_.push(new PropertyStruct("margin_top",var_72.top,PropertyStruct.const_84,true));
         _loc1_.push(new PropertyStruct("margin_right",var_72.right,PropertyStruct.const_84,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_72.bottom,PropertyStruct.const_84,true));
         _loc1_.push(new PropertyStruct("auto_size",var_484,PropertyStruct.const_229,var_484 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_59,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_59,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_59,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_59,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_654,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_570 = var_570;
         _loc1_.var_347 = var_347;
         _loc1_.var_72 = var_72.clone(_loc1_.setTextMargins);
         _loc1_.var_484 = var_484;
         _loc1_.var_687 = var_687;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_484 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_484 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_484 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_484 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
