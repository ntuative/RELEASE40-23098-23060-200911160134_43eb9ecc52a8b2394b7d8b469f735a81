package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1017:String = "_TITLE";
      
      private static const const_1054:String = "_CONTENT";
      
      private static const const_1055:String = "_HEADER";
      
      private static const const_1053:String = "_SCALER";
      ...
      private var var_1174:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_221);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_213);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_186);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_186,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_186,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1174 == null)
         {
            var_1174 = findChildByTag(const_1055) as IHeaderWindow;
            if(!var_1174)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1017) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1053) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1275 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1054) as IWindowContainer;
            if(!var_33)
            {
