package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      {
         var_572 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_31)
         {
            var_31 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_798,var_22);
            GraphicContext(var_31).mouseEnabled = true;
            GraphicContext(var_31).doubleClickEnabled = true;
         }
         return var_31;
      }
