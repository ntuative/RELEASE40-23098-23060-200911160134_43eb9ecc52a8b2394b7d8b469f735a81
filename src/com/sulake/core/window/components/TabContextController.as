package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1083:String = "content";
      
      private static const const_1082:String = "selector";
       
      
      private var var_1253:Boolean = false;
      
      protected var var_858:ITabSelectorWindow;
      
      private var var_842:Boolean = false;
      
      protected var var_1503:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1503 == null)
         {
            var_1503 = findChildByTag(TabContextController.const_1083) as IWindowContainer;
         }
         return var_1503;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_858 == null)
         {
            var_858 = findChildByTag(TabContextController.const_1082) as ITabSelectorWindow;
            if(var_858 != null)
            {
               var_858.procedure = selectorEventProc;
            }
         }
         return var_858;
      }
      ...
      {
         return !!var_842 ? selector.iterator : null;
      }
