package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_987:String = "WKE_KEY_UP";
       
      
      private var var_593:KeyboardEvent;
      ...
      {
         _type = param1;
         var_593 = KeyboardEvent(param2);
         super(param1,param3,param4,param5,false);
      }
      
      public function get keyLocation() : uint
      {
         return var_593.keyLocation;
      }
      
      public function get shiftKey() : Boolean
      {
         return var_593.shiftKey;
      }
      
      public function get charCode() : uint
      {
         return var_593.charCode;
      }
      
      public function get keyCode() : uint
      {
         return var_593.keyCode;
      }
      
      public function get altKey() : Boolean
      {
         return var_593.altKey;
      }
      ...
      {
         return new WindowKeyboardEvent(_type,var_593,window,related,bubbles,cancelable);
      }
   }
}
