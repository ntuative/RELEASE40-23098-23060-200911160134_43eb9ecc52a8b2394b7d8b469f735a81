package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         return var_400 == int.MIN_VALUE && var_399 == int.MAX_VALUE && var_398 == int.MIN_VALUE && var_401 == int.MAX_VALUE;
      }
      ...
      {
         var_400 = param1;
         if(var_400 > int.MIN_VALUE && true && _target.width < var_400)
         {
            _target.width = var_400;
         }
      }
