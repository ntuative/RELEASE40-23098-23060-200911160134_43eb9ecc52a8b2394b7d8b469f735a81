package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private var var_299:Rectangle;
      
      protected var var_572:Function;
      
      protected var _children:ChildEntityArray;
      
      protected var var_862:Boolean;
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_299 = new Rectangle();
         var_489 = 10;
         if(_loc13_ != null)
         {
            var_348 = new Rectangle(0,0,int(_loc13_.attribute("width")),int(_loc13_.attribute("height")));
            var_59 = var_348.clone();
            var_22 = var_348.clone();
         ...
         if(param8 != null)
         {
            ...
            if(var_31)
            {
               _context.invalidate(this,var_22,WindowRedrawFlag.const_68);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_127);
         var _loc2_:* = !testParamFlag(WindowParam.const_119,WindowParam.const_124);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_235)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_317)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_5 = param1;
         var_411 = !!var_5 ? uint(var_411 | _alphaColor) : uint(var_411 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_68);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_455)
         {
            return true;
         }
         ...
         _loc1_.type = WindowNotifyEvent.const_789;
         update(this,_loc1_);
         dispose();
         return true;
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2050 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_843:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_292:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_807:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_903:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_789:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_846:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_542:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_935:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_791:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_456:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_422:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_389:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_283:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_877:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_664:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_86 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_387,this,null));
         }
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_807,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_791,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_31)
         {
            var_31 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_696,var_22);
            var_31.visible = var_310;
         }
         return var_31;
      }
      
      public function method_12() : Boolean
      {
         if(_state & 0)
         {
            return false;
         }
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_938,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_855;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_372 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_22,WindowRedrawFlag.const_900);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_996 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_283,this,param1));
         return param1;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_411 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_68);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_699))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_954;
                  if(testParamFlag(WindowParam.const_310))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_209))
                        {
                  ...
                  if((var_30 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        ...
                        {
                           _context.getWindowServices().getMouseScalingService().begin(_loc5_,var_30 & 0);
                           break;
                        }
                        _loc5_ = _loc5_.parent;
                     }
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_209))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_223:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_360,this,null));
                     if(testParamFlag(WindowParam.const_160,WindowParam.const_127))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_152,WindowParam.const_124))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        _loc8_ = uint(var_30);
                        var_30 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_399))
                        {
                           var_23.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_469:
                  _context.invalidate(this,var_22.union(var_59),WindowRedrawFlag.const_401);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_985,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_222,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_292:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_700,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_189,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_456:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_984);
                  break;
               case WindowNotifyEvent.const_387:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_422:
                  if(!(var_30 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_401);
                     }
                  }
                  else if(var_30 & 0)
                  {
               ...
               case WindowNotifyEvent.const_189:
                  ...
                  break;
               case WindowNotifyEvent.const_360:
                  var_23.getRegionProperties(null,var_299);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_283:
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_963,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         return var_572 != null ? var_572 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_292;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_664,this,param1));
            return param1;
         }
         return null;
      }
      ...
      {
         if(getStateFlag(WindowState.const_65))
         {
            return true;
         }
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_542;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_996 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_410)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_429)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_30 & 0);
            if(_loc7_ == WindowParam.const_466)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_359)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_821,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_469,this,null));
            }
            if(_loc6_)
            {
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_456,this,null));
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_60,true);
         _loc1_.type = WindowNotifyEvent.const_1327;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_306 && var_489 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1477,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1477,param3,param1)) : false;
            }
         }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_30 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_422,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_299 = var_23.rectangle.clone();
               var_59.x = var_22.x;
               var_59.y = var_22.y;
               var_59.width = var_22.width;
               var_59.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_389,this,var_23));
            }
            else
            {
               var_299.x = 0;
               ...
               var_299.width = 0;
               var_299.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_877,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_235,_type,var_86,var_30,_context,var_22,null,var_572,properties,var_571.concat(),_id) as WindowController;
         _loc2_.var_489 = var_489;
         _loc2_.var_306 = var_306;
         _loc2_.var_862 = var_862;
         _loc2_.var_299 = var_299.clone();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1264,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_60,false);
         _loc1_.type = WindowNotifyEvent.const_1303;
         update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_817,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         setStateFlag(WindowState.const_65,false);
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_703;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_824;
         update(this,_loc1_);
         return true;
      }
