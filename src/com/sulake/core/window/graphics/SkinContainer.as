package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_352:Array;
      
      private static const const_1051:uint = 8;
       
      
      private var var_457:Dictionary;
      
      private var var_1872:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1415 = new Dictionary();
         var_1871 = new Dictionary();
         TypeCodeTable.fillTables(var_1415,var_1871);
         var_1164 = new Dictionary();
         var_1872 = new Dictionary();
         StateCodeTable.fillTables(var_1164,var_1872);
         ...
         var_457["ModAlertMessageComposer"] = NullSkinRenderer;
         if(var_352 == null)
         {
            var_352 = new Array();
            var_352.push(WindowState.const_60);
            var_352.push(WindowState.const_65);
            var_352.push(WindowState.const_82);
            var_352.push(WindowState.const_44);
            var_352.push(WindowState.const_73);
            var_352.push(WindowState.const_70);
            var_352.push(WindowState.const_83);
            var_352.push(WindowState.const_78);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1164)
         {
            _loc3_.push(var_1164[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1415[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_537[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_537[param1] = new Array(SkinContainer.const_1051);
         }
         var_537[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_537[_loc1_]).dispose();
