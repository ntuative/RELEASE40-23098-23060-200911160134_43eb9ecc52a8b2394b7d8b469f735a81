package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_798:uint = 256;
      
      protected static var var_573:uint = 0;
      
      protected static var var_351:uint = 0;
      
      public static const const_933:uint = 2;
      
      public static const const_1430:uint = 128;
      ...
      public static const const_1247:uint = 16;
      
      public static const const_696:uint = 1;
      
      public static const const_1225:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_933:
               ...
               break;
            case GraphicContext.const_1225:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1247:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_715:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_798:
               break;
            case GraphicContext.const_1104:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_567)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_351 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_567)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_351 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1498,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1498,16777215);
                  }
                  var_351 += bitmap.width * bitmap.height * 4;
               }
