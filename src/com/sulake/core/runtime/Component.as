package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1482:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_1202:uint = 4;
      ...
      protected var var_182:InterfaceStructList;
      
      protected var var_2133:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_363:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1906:Boolean = false;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1026 = param2;
         var_182 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_182.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_863 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_863);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1026 & const_1202)
         {
            if(_loc3_ == 0)
            {
               if(var_182.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_182.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_363 + "]";
      }
   }
}
