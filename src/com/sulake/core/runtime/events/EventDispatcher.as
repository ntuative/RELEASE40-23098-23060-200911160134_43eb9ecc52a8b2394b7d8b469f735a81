package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_747:uint = 2;
       
      
      private var var_1408:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(var_625 == const_747)
            {
               throw var_1408;
            }
            return var_625 == const_477;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         var array:Array = var_260[event.type];
         ...
         var_625 = !!event.isDefaultPrevented() ? uint(const_1044) : uint(const_477);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_260)
            {
               _loc2_ = var_260[_loc1_] as Array;
               for each(_loc3_ in _loc2_)
               {
                  _loc3_.callback = null;
               }
               delete var_260[_loc1_];
            }
            var_260 = null;
            var_69 = null;
            _disposed = true;
