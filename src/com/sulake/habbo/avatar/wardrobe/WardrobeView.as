package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_643:IItemListWindow;
      
      private var var_545:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_799:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_643 = _window.findChildByName("mylooks") as IItemListWindow;
         var_545 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_799 = _window.findChildByName("selector") as IItemListWindow;
         var_1433 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_92.controller.catalog.openCatalogPage(CatalogPageName.const_272,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_92.selectMyLook(var_643.getListItemIndex(param2.parent));
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_546)
         {
            var_799.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_546 = [];
         while(true)
         {
            ...
            var_799.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in var_92.hotLooks)
         {
            ...
            {
               var_545.addListItem(_loc3_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_799.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_798 * 8 + var_545.getListItemIndex(param2.parent);
