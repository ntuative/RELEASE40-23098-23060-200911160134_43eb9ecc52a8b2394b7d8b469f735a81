package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1310:PaletteManager;
      
      private var var_690:CoreComponent;
      
      private var var_1311:ILogger;
      
      private var var_1055:PetDataManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            var_690 = CoreComponent(param1);
            var_690.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_494.getValue(AvatarType.const_92) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
         _loc2_ = var_494.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
      ...
      {
         return var_1055 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_494.getValue(AvatarType.const_92) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc5_:String = var_1055.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_494.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:AssetLibraryCollection = var_690.assets as AssetLibraryCollection;
         var _loc3_:int = 0;
         ...
         var_1055 = new PetDataManager(_loc2_,_loc4_);
         var_1310 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1055.populateFigureData(_loc5_);
         ...
         var_494.add(AvatarType.const_92,_loc6_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.PET);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_494.add(AvatarType.PET,_loc6_);
      ...
      {
         var _loc2_:AvatarStructure = var_494.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1310.getPalette(0);
