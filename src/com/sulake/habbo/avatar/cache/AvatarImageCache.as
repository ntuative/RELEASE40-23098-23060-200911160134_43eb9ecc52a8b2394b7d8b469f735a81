package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1371:int = 60000;
      ...
      private var var_699:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_85.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_141.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_141.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_85.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               _loc8_ = _loc4_ + _loc15_.directionOffset;
               if(_loc15_.directionOffset < 0)
               {
                  if(_loc8_ < 0)
                  {
                     _loc8_ = 8 + _loc8_;
               ...
               if(var_199 == AvatarScaleType.const_93)
               {
                  _loc9_.x = _loc15_.dx / 2;
                  _loc9_.y = _loc15_.dy / 2;
               }
               else
               {
                  _loc9_.x = _loc15_.dx;
               ...
               _loc12_ = _loc15_.animationFrame;
               _loc5_ = _loc15_.action;
               if(_loc15_.type == AnimationLayerData.const_660)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_369)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         var _loc13_:AvatarImageActionCache = _loc3_.getActionCache(_loc6_);
         if(_loc13_ == null)
         {
            debugInfo("[CacheMiss (bodyPartCache.getActionCache)] [AvatarImageCache.getImageContainer] action.id: " + [param1,_loc5_.id]);
            _loc13_ = new AvatarImageActionCache();
            _loc3_.updateActionCache(_loc6_,_loc13_);
         }
         var _loc14_:AvatarImageDirectionCache = _loc13_.getDirectionCache(_loc4_);
         if(_loc14_ == null)
         {
            debugInfo("[CacheMiss (actionCache.getDirectionCache)] [AvatarImageCache.getImageContainer] direction: " + [param1,_loc4_]);
            _loc10_ = var_85.getParts(param1,(var_699 as AvatarImage).getFigure(),_loc6_,var_1183,_loc4_);
            _loc14_ = new AvatarImageDirectionCache(_loc10_);
            _loc13_.updateDirectionCache(_loc4_,_loc14_);
         }
         _loc11_ = _loc14_.getImageContainer(_loc12_);
         if(_loc11_ == null)
         {
            debugInfo("[ImageContainer (" + _loc5_.id + " " + _loc5_.definition + " type: " + _loc5_.actionType + ")]");
            _loc16_ = _loc14_.getPartList();
            _loc11_ = renderBodyPart(_loc4_,_loc16_,_loc12_,_loc5_);
            if(_loc11_ != null)
            {
               debugInfo("[ImageContainer creation (" + _loc5_.id + " " + _loc5_.definition + " type: " + _loc5_.actionType + ")]");
               _loc14_.updateImageContainer(_loc11_,_loc12_);
            }
            else
            {
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_85.getCanvas(var_199,var_1183);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1245[param1])
            {
               if(!((_loc11_ == "lh" || _loc11_ == "ls" || _loc11_ == "lhs") && _loc31_ == "wav"))
               {
                  if(!((_loc11_ == "rh" || _loc11_ == "rhs" || _loc11_ == "rs") && _loc31_ == "drk"))
                  {
            ...
            _loc10_ = var_199 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_199 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_85.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_788 || _loc32_ == AvatarAction.const_534) && (_loc6_ == AvatarBodyPartType.const_307 || _loc6_ == AvatarBodyPartType.const_1257 || _loc6_ == AvatarBodyPartType.const_1318) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_199 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_85.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_141 != null)
         {
            _loc2_ = var_141.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_141.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_85.getBodyPartsUnordered(param1);
