package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1064:String = AvatarSetType.const_37;
      
      private static const const_1063:String = "Default";
      
      private static const const_1062:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_540:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_199 == null)
         {
            var_199 = AvatarScaleType.const_50;
         }
         ...
         var_540 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_540.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_969;
         }
         var_141 = new AvatarImageCache(var_85,this,_assets,var_199);
         setDirection(const_1064,const_1061);
         var_200 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            param2 = AvatarDirectionAngle.const_597 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_597)
         {
            param2 -= NaN;
         }
         if(var_712 == AvatarType.PET && param1 == AvatarSetType.const_48)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_85.sortActions(var_200);
         if(_loc1_ == null)
         {
         ...
         {
            var_541 = var_85.getCanvasOffsets(_loc1_,var_199,var_101);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1175 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_534)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_465)
            {
               _isAnimating = true;
            }
            if(_loc2_.actionType == AvatarAction.const_358)
            {
               _isAnimating = true;
            }
         }
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_200.length)
         {
            _loc3_ = var_200[_loc4_];
         ...
         var_200.push(new ActiveActionData(param1,param2));
      }
      
      public function getPartColor(param1:String) : IPartColor
      {
         return var_85.getPartColor(var_540,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_85.getCanvas(var_199,var_169.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_85.getBodyParts(param1,var_169.definition,var_101);
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_712 == AvatarType.PET)
               {
                  ...
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_85.getPartActionOffset(getSubType(),var_199,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_85.getCanvas(var_199,var_169.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_85.getBodyParts(param1,var_169.definition,var_101);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_712 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_85.getParts(_loc7_,var_540,_loc12_,"pet",_loc11_.getDirection());
                  _loc15_ = 32;
                  if(var_199 == AvatarScaleType.const_93)
                  {
                     _loc15_ = 6;
                  ...
                  {
                     _loc16_ = _loc14_[0];
                     _loc17_ = _loc16_.getFrameIndex(var_462);
                     _loc18_ = var_101;
                     _loc19_ = 1;
                     switch(var_101)
                     {
                     ...
                     _loc20_ = var_85.getPartActionOffset(getSubType(),var_199,_loc7_,_loc13_,_loc17_,_loc18_);
                     if(_loc20_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_169 = new ActiveActionData(AvatarAction.const_808);
         var_169.definition = var_85.getActionDefinition(const_1063);
      ...
      {
         return var_85.getBodyPartData(param1.animation.id,var_462,param1.id);
      }
