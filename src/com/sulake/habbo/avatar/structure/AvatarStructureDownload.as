package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_939:String = "AVATAR_STRUCTURE_DONE";
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_249 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_1749.append(var_249);
         dispatchEvent(new Event(AvatarStructureDownload.const_939));
      }
   }
}
