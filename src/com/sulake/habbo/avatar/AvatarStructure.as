package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_359:PartSetsData;
      
      private var var_1656:PartOffsetData;
      ...
      private var var_1343:AvatarStructureDownloadSet;
      
      private var var_711:AvatarActionManager;
      
      private var var_151:IAssetLibrary;
      
      private var var_425:FigureData;
      
      private var var_2153:IAssetLibrary;
      
      private var var_1275:Boolean = false;
      
      private var var_582:AnimationManager;
      
      private var var_1655:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_151 = param2;
         var_2153 = param3;
         var_425 = new FigureData();
         var_359 = new PartSetsData();
         _animationData = new AnimationData();
         var_1343 = new AvatarStructureDownloadSet();
         var_582 = new AnimationManager();
         var_712 = param4;
         var_1656 = PartOffsetData.getInstance(param3);
      }
      ...
      {
         return var_711.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_582.getAnimation(param1);
      }
      
      public function init(param1:IHabboConfigurationManager) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:* = null;
         initGeometry();
         initActions();
         var _loc2_:String = param1.getKey("external.figurepartlist.txt");
         var _loc6_:Boolean = false;
         switch(var_712)
         {
            case AvatarType.const_92:
               _loc3_ = var_151.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_359.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_151.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_151.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_425.parse(_loc5_))
               {
                  return;
               }
               var_1343.add(new AvatarStructureDownload(var_151,_loc2_,var_425));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_151.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_359.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_151.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_151.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_425.parse(_loc5_))
               {
                  return;
               }
         ...
         if(_loc6_)
         {
            var_1343.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
         }
         else
         {
            onStructureReady();
      ...
      {
         return var_711.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_711.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_711 = new AvatarActionManager(var_151,var_712);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_582.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_359.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_359.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_711.getDefaultActionType();
         var _loc7_:Array = var_359.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_582.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_425.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_425.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_359.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_359.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_92:
               if(var_151.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_151.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_151.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_151.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_151.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_151.getAssetByName("dance" + _loc1_).content as XML;
            var_582.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_151.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_151.getAssetByName("fx" + _loc1_).content as XML;
            var_582.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_425.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_425.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_712 + " ready to go!");
         if(var_712 == AvatarType.const_92)
         {
            var_359.getPartDefinition("ri").appendToFigure = true;
            var_359.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      {
         return var_711.sortActions(param1);
      }
   }
}
