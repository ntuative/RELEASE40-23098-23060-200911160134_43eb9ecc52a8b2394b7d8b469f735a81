package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      private var var_429:IWindowContainer;
      
      private var var_294:String = "";
      
      private var var_92:HeadModel;
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_648 = new Dictionary();
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_108,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_141,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_135,param2,param3);
         attachImages();
         switchCategory(FigureData.const_108);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_648[var_1344];
         if(_loc2_ == null)
         {
            return;
         }
