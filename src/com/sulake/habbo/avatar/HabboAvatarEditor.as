package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1005:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1005.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1006)
         {
            var_679 = new Dictionary();
            var_679["null"] = new FigureData(this);
            var_679["null"] = new FigureData(this);
            _loc1_ = var_679["null"];
            _loc2_ = var_679["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_75);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_76);
            var_323 = new Map();
            var_323.add(AvatarEditorCategory.const_922,new GenericModel(this));
            var_323.add(AvatarEditorCategory.const_48,new HeadModel(this));
            var_323.add(AvatarEditorCategory.const_307,new TorsoModel(this));
            var_323.add(AvatarEditorCategory.const_1124,new LegsModel(this));
            var_323.add(AvatarEditorCategory.const_599,new WardrobeModel(this));
            var_1006 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_323.getValue(AvatarEditorCategory.const_599);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_323.getValue(AvatarEditorCategory.const_599);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1005.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1496.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1273.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1329)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1273.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_323.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_404 == null)
            {
               var_404 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_404.addChild(_view.window);
               var_404.center();
               var_404.visible = false;
            }
            var_404.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_922);
         if(var_178 != null)
         {
            urlString = var_178.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1219 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_536,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1005 = var_1219.getFigureData(AvatarType.const_92);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1007 = param3;
         var _loc4_:FigureData = var_679[param2];
         if(_loc4_ == null)
         {
            return;
         }
