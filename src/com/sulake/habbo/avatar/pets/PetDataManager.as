package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_557.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_557.getValue(param1) as IPetData;
      }
      ...
      public function createAvatarFigureString(param1:String) : String
      {
         ...
         var _loc6_:PetData = var_557.getValue(_loc3_);
         if(_loc6_ == null)
         {
      ...
      {
         var _loc4_:PetData = var_557.getValue(param1);
         if(_loc4_ == null)
         {
            Logger.log("Could not find Pet Data: " + param1);
            return "";
         }
         var _loc5_:Breed = _loc4_.breeds[param2];
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_557.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_557.getValue(key);
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.method_3.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
