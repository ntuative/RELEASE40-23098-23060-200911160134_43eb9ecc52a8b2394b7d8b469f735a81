package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1293:Number = 1;
      
      private var _b:uint;
      
      private var var_1290:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1291,var_1290,var_1293,_alphaMultiplier);
         var_1003 = generatePaletteMapForGrayscale(var_2062,var_2064);
      }
      
      public function get reds() : Array
      {
         return var_1003.getValue("reds") as Array;
      }
      ...
      {
         return var_1003.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1003.getValue("greens") as Array;
      }
      ...
      {
         return var_1003.getValue("alphas") as Array;
      }
