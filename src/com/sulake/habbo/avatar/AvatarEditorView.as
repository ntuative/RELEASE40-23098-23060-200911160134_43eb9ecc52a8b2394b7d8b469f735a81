package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1496:IWindowContainer;
      
      public static var var_1273:IWindowContainer;
      
      public static var var_1020:int = 6710886;
       
      
      private var var_1335:Boolean = true;
      
      private var var_165:Timer;
      
      private var var_1336:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1273 == null)
         {
            ...
            var_1273 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1496 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1496 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         var_165 = new Timer(1000);
         var_165.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_898 != null)
         {
            toggleCategoryView(var_898,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1336 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_165.stop();
            var_165.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_165 = null;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_898 = param1;
         var_1336.setSelected(var_1336.getSelectableByName(param1));
         _window.invalidate();
      }
