package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1555:int = 8947848;
      
      private const const_1554:int = 13421772;
      
      private var _isSelected:Boolean = false;
      
      private var var_1371:BitmapData;
      ...
      private var var_844:IPartColor;
      
      private var var_1089:BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_592.width,var_592.height,true,0);
            _loc1_.bitmap.copyPixels(var_592,var_592.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1089.width,var_1089.height,true,0);
            _loc4_ = var_1089.clone();
            _loc4_.colorTransform(_loc4_.rect,var_844.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_914.width,var_914.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_914,var_914.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1371,var_1371.rect,new Point(0,0),null,null,true);
            }
         }
      }
