package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_605 > -1)
         {
            return var_319[var_605] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_605 >= 0)
         {
            _loc3_ = var_319[var_605];
            _loc3_.isSelected = false;
         }
         if(var_319.length > param1)
         {
            _loc2_ = var_319[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_605 = param1;
