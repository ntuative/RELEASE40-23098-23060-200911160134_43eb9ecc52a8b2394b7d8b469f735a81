package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1554:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1371:BitmapData;
      
      private const const_1555:int = 13421772;
      
      private var var_735:Rectangle;
      ...
      private var var_512:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_350 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_924 = param3.isColorable;
         }
         var_924 = param5;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_350 != null)
            {
               _loc2_ = var_350.clone();
               if(_color != null && var_924)
               {
         ...
         if(var_512 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1371,var_1371.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1555;
         }
         else
         {
            _window.color = const_1554;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_735.width,var_735.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_937 + "_" + FigureData.const_255;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_924 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_937 + "_" + FigureData.const_255;
