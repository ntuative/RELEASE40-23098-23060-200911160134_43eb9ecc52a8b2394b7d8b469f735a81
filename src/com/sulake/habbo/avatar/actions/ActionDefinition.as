package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1299 = new Dictionary();
         super();
         _id = String(param1.@id);
         _state = String(param1.@state);
         var_1517 = parseInt(param1.@precedence);
         var_1521 = String(param1.@activepartset);
         var_1515 = String(param1.@assetpartdefinition);
         var_1518 = String(param1.@lay);
         var_1183 = String(param1.@geometrytype);
         var_1514 = Boolean(parseInt(param1.@main));
         var_1516 = Boolean(parseInt(param1.@name_1));
         var_1519 = Boolean(parseInt(param1.@animation));
      ...
      public function method_10(param1:String, param2:int, param3:Array) : void
      {
         if(var_541 == null)
         {
            var_541 = new Map();
