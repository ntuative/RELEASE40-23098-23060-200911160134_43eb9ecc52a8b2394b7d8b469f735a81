package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1808:BitmapData = null;
      ...
      private var var_1809:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_340,0,0,_loc4_,var_1396,var_1809,var_1808));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1807 = int(_config.getKey("interstitial.interval","30000"));
         var_1805 = int(_config.getKey("interstitial.show.time","5000"));
         var_1397 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1137 = _loc2_.imageUrl;
         var_1396 = _loc2_.clickUrl;
         if(var_1137 != "" && var_1396 != "")
         {
            _loc3_ = var_1137;
            ...
            _loc4_ = new URLRequest(var_1137);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1138 = _loc2_.imageUrl;
         var_1806 = _loc2_.clickUrl;
         var_617 = getTimer();
         if(var_1138 != "")
         {
            _loc3_ = var_1138;
            ...
            if(var_222 == null)
            {
               var_222 = new Timer(var_1805,1);
               var_222.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_222.reset();
            ...
            var_222.start();
            _loc4_ = new URLRequest(var_1138);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_357,0,0,param1.bitmapData,var_1806));
            var_617 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1808 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1397 > 0 && var_1398 >= var_1397)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_617;
         if(_loc1_ > var_1807)
         {
            ++var_1398;
      ...
      {
         var_613 = param2 as IHabboCommunicationManager;
         if(var_613 == null)
         {
            return;
         }
         _connection = var_613.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1809 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
