package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      public function get size() : Number
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_302.length)
         {
            if(var_302[_loc2_].exists)
            {
               _loc1_ += var_1261;
            }
            _loc2_++;
      ...
      {
         return var_1260.indexOf(param1) > -1;
      }
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_302.length)
         {
            _loc2_ = var_302[_loc3_];
            if(_loc2_ != null)
            {
      ...
      {
         return var_678.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = var_678.indexOf(var_1259[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_302[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_738 + _loc3_);
                  _loc3_ += var_1261;
               }
            }
            _loc4_++;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_678.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_302[var_678.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_2079.elements("menu");
         var _loc5_:int = 0;
