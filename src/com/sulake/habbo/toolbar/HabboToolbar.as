package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_613.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_111,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_834,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_157,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_151,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_43,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_386,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_676,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_897,onHideWindowEvent);
         _state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_77));
      }
