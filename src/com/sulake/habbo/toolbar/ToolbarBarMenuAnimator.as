package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1069:Number = 90;
      
      private static const const_733:int = 50;
      
      private static const const_1010:Number = 25;
      
      private static const const_1011:int = 50;
      
      private static const const_177:Boolean = true;
       
      
      private var var_510:Timer;
      
      private var var_923:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_923 = param2;
         var_510 = new Timer(const_1010);
         var_510.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function getWindowByName(param1:String) : IWindow
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = _windowManager.getWindowContextLayer(0);
            if(_loc3_ != null)
            {
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_437.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_437.splice(_loc3_,1);
            var_438.splice(_loc3_,1);
         }
         var_438.push(param1.name);
         var_437.push(param2);
         param1.addEventListener(WindowEvent.const_365,windowEventListener);
         param1.addEventListener(WindowEvent.const_201,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_437[var_438.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_923.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_284.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_284.splice(var_284.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_923.getIconLoc(param1.iconId);
      ...
      {
         return var_438[var_437.indexOf(param1)];
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_284.length)
         {
            repositionWindow(var_284[_loc1_],true);
            _loc1_++;
         }
      }
         ...
         if(const_177)
         {
            if(_loc4_ != null)
            {
               ...
               while(_loc8_ < _loc4_.length)
               {
                  ...
                  if(_loc9_ != null && _loc9_.visible == true)
                  {
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_511[_loc3_] = new Array();
            }
            if(var_511[_loc3_].indexOf(param1) < 0)
            {
               var_511[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_733 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_733 || param1.desktop.height - param1.y < const_1011;
      }
      
      private function repositionWindow(param1:String, param2:Boolean) : void
      {
         var _loc3_:MenuAnimatorItem = getItemObject(param1);
         if(_loc3_ == null)
         {
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_438.length)
         {
            if(var_438[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_511[_loc3_].length)
                  {
                     repositionWindow(var_511[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
