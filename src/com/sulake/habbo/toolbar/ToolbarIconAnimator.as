package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1136 = param1.loop;
         if(param1.background != null)
         {
            var_767 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_769.push(new XML());
               var_768.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_768[var_55] = param6.clone();
         }
      ...
      {
         if(var_1136 == true || var_616 == 0)
         {
            if(false)
            {
               ++var_55;
               if(var_55 >= var_769.length)
               {
                  var_55 = 0;
                  ++var_616;
               }
      ...
      {
         return var_769.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1136 == false && var_616 == 1 && var_1238 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_767 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_767.width),Math.max(param2.height,var_767.height));
            _loc3_.copyPixels(var_767,var_767.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_55 <= var_768.length)
         {
            _loc2_ = var_768[var_55];
