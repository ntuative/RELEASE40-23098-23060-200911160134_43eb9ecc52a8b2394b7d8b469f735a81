package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1043:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_591,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_121,onDoorbellRejected);
      ...
      private function onDoorbellRejected(param1:RoomWidgetDoorbellEvent) : void
      {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_591,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_121,onDoorbellRejected);
      }
