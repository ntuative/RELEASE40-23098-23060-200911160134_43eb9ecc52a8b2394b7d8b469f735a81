package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_390:String = "CPV_MODE_TRIAL";
      
      public static const const_1313:String = "CPV_MODE_FULL";
      ...
      private const const_1042:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1042,_loc7_,"image/png");
            _loc8_.addEventListener(AssetLoaderEvent.const_30,onPromoImageReady);
         }
         if(param3 == const_390)
         {
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1042))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1042) as BitmapDataAsset;
            _loc3_ = (_loc2_.content as BitmapData).clone();
            _loc1_.width = _loc3_.width;
            _loc1_.height = _loc3_.height;
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_541,_loc2_.text,var_680 == const_390);
