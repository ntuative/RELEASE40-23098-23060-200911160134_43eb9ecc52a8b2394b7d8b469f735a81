package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_813:IWindow;
      
      private var var_814:IWindow;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_813 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_173.duration);
               var_813.width = _loc2_ * var_399;
            }
            else
            {
               var_813.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_814 = _window.findChildByName("effect_hilite");
            var_814.visible = false;
         }
         var_815 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_813 = _window.findChildByName("loader_bar");
         if(var_813 != null)
         {
            var_399 = var_813.width;
            var_165.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_173.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_815 != null)
         {
            var_815.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_815.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
