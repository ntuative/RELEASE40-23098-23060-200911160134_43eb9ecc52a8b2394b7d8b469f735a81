package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1552:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1231 != null && var_1231.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_114);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_705 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_705 += param1.height + const_1551;
            return fit(param1);
         }
         param1.offset(_offsetX,var_705);
         _offsetX += param1.width + const_1552;
         return true;
      }
