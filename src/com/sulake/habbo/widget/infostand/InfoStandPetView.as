package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1569:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1563:String = "level";
      
      private var var_105:IItemListWindow;
      
      private const const_1566:String = "energy";
      
      private var var_1159:Map;
      
      private const const_1562:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1568:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1565:int = 158;
      
      private const const_1567:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_269:PetCommandTool;
      
      private const const_1570:uint = 11184810;
      
      private const const_1564:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_212.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_212.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_.addEventListener(WindowEvent.const_46,onButtonResized);
         }
      }
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_105.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1159.getValue(var_746) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_105.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set setRaceText(param1:String) : void
      {
         if(var_105 == null)
         {
            return;
         }
         var _loc2_:ITextWindow = var_105.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         setRaceText = _widget.localizations.getKey(getRaceLocalizationKey(param1.type,param1.race));
         petRespect = param1.petRespect;
         updateStateElement(const_1563,param1.level,param1.levelMax);
         updateStateElement(const_1564,param1.experience,param1.experienceMax);
         updateStateElement(const_1566,param1.energy,param1.energyMax);
         updateStateElement(const_1562,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_746 = param1.id;
         var_1159.remove(param1.id);
         var_1159.add(param1.id,param1);
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_105.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_395,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1565,const_1567,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1570);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1568);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1569);
         return _loc5_;
      }
