package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1356:String = "infostand_user_view";
      
      private var var_285:InfoStandPetView;
      
      private var var_1159:InfoStandPetData;
      
      private var var_131:Timer;
      
      private var var_737:InfoStandFurniView;
      
      private var var_358:InfostandFurniData;
      
      private var var_513:InfoStandBotView;
      ...
      private const const_1357:String = "infostand_furni_view";
      
      private const const_1556:int = 3000;
      
      private var var_190:InfoStandUserView;
      
      private var var_385:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_737 = new InfoStandFurniView(this,const_1357);
         var_190 = new InfoStandUserView(this,const_1356);
         var_285 = new InfoStandPetView(this,const_1358);
         var_513 = new InfoStandBotView(this,const_1355);
         var_385 = new InfostandUserData();
         var_358 = new InfostandFurniData();
         var_1159 = new InfoStandPetData();
         var_131 = new Timer(const_1556);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_190.setTags(param1.tags,var_1743);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_501,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_705,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_640,var_285.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_227,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_501,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_705,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_513.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_115:
               _loc2_ = param1.id == var_358.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_227:
               if(var_190 != null && false && var_190.window.visible)
               {
                  _loc2_ = param1.id == var_385.userRoomId;
                  break;
               }
               if(var_285 != null && false && var_285.window.visible)
               {
                  _loc2_ = param1.id == var_1159.roomIndex;
                  break;
               }
         }
         if(_loc2_)
      ...
      {
         var_285.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
