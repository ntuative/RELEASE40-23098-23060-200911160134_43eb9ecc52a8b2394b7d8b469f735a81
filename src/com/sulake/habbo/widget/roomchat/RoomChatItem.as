package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_473:int = 6;
      
      private static const const_329:int = 10;
      
      private static const const_1005:Number = 18;
      
      private static const const_1352:Number = 10;
      
      private static const const_1353:Number = 8;
       
      
      private var var_1077:Number;
      ...
      private var var_188:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_899,var_901,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_899,var_901,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1078 = param1.chatType;
         var_899 = param1.userId;
         var_715 = param1.userName;
         var_901 = param1.userCategory;
         _message = param1.text;
         var_1077 = param1.userX;
         var_188 = param1.userImage;
         var_900 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_90,_y,width,_height);
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_42,onBubbleMouseDown);
      ...
      public function renderView() : void
      {
         ...
         switch(var_1078)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_250:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_266:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_188 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_188.height);
         }
         ...
         if(var_188 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_188.width;
               _loc28_.height = var_188.height;
               _loc28_.bitmap = new BitmapData(var_188.width,var_188.height,true,0);
               _loc28_.bitmap.copyPixels(var_188,var_188.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_360 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_188.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_900 != 0)
            {
               _loc31_ = uint(var_900 >> 16 & 255);
               _loc32_ = uint(var_900 >> 8 & 255);
               _loc33_ = uint(var_900 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_329;
            }
            else
            {
               _loc19_.text = var_715 + ":";
               _loc19_.y += var_360;
               _loc19_.width = _loc19_.textWidth + const_329;
               _width += _loc19_.textWidth + const_329;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1078 == RoomWidgetChatUpdateEvent.const_250)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_715);
            }
            else if(var_1078 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_715);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_360;
            _loc20_.width = _loc20_.textWidth + const_473;
            _width += _loc20_.textWidth + const_473;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_329 + _loc20_.textWidth + const_473;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_899,var_901,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_899,var_901,_roomId,_roomCategory,param1);
      }
