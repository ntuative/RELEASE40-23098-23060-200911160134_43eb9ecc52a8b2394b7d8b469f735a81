package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1361:int = 5;
      
      private static const const_473:int = 16;
      
      private static const const_1027:int = 20;
      
      private static const const_329:int = 10;
      
      private static const const_1028:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_940 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1781 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1780 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_610 = new Timer(1000,1);
         var_610.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_757 = new Timer(5000,1);
         var_757.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_125,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_46,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_224,onInputChanged);
         _window.addEventListener(WindowEvent.const_365,onWindowMoved);
         var_1126 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1779 = _loc2_.width + const_473 + _loc6_.width + const_1027;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1028,_loc8_.width) + const_473);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_940 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_136 = "";
               }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_42,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_449);
