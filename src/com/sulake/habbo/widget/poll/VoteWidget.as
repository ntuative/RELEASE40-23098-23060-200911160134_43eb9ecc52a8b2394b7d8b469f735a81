package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_657:Array = null;
      ...
      private var var_1053:int = 30000;
      
      private var var_1052:Boolean = false;
      
      private var var_871:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1053 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_122,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_106,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_309,update);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(_list.scrollableRegion.height - 0,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         _list = _window.findChildByName("choices") as IItemListWindow;
         if(_list == null)
         {
            return false;
         }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1553;
         if(_loc2_ > var_1053)
         {
            vote();
            return;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(_list.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < _list.numListItems)
         {
            _loc4_ = _list.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < _list.numListItems)
         {
            _loc2_ = _list.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_122,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_106,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_309,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1053 - param1) / 1000,0);
