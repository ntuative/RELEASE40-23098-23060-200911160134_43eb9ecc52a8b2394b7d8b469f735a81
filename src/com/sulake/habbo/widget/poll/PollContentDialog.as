package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_44))
                        {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_647[var_976] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_293)
         {
            ...
            var_293 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_293.center();
            var_293.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_976;
         if(var_976 < var_647.length)
         {
            _loc1_ = var_647[var_976] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_647.length);
                  _loc2_.text = _loc6_;
               }
