package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1375:uint = 0;
      
      private const const_1374:uint = 4.293848814E9;
      
      private var _title:String;
      
      private var _widget:ChooserWidget;
      
      private const const_1571:uint = 4.282169599E9;
      ...
      public function ChooserView(param1:ChooserWidget, param2:String)
      {
         super();
         _widget = param1;
         _title = param2;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1465);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_671)
         {
            return;
         }
         if(var_671 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_671) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_671 % 2) ? uint(const_1375) : uint(const_1374);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1571;
            var_671 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1375) : uint(const_1374);
