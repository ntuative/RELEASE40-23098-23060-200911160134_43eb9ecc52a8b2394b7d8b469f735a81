package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_723,var_698);
      ...
      {
         hideInterface();
         var_698 = param1.objectId;
         var_1048 = param1.creditValue;
         showInterface();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_590,onObjectUpdate);
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "link":
               ...
               {
                  navigateToURL(new URLRequest(_loc4_),"habboMain");
               }
               break;
            case "exchange":
               sendRedeemMessage();
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1048));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_991,const_992,2,2),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_590,onObjectUpdate);
      }
   }
}
