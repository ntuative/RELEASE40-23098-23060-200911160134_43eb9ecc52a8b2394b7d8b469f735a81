package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_98 && param1.type != WindowMouseEvent.const_703)
         {
            return;
         }
      ...
      {
         return int(var_1446 * (Number(param1 - var_664) / (var_985 - var_664)));
      }
      ...
      {
         return int(param1 / var_1446 * (var_985 - var_664)) + var_664;
      }
   }
}
