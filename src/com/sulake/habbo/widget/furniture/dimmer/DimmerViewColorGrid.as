package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_470:BitmapData;
      
      private var var_1186:XML;
      
      private var var_278:IWindowContainer;
      
      private var var_390:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_390.destroyGridItems();
         var_278 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1186) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_470.width;
            _loc3_.height = var_470.height;
            var_390.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_470.width,var_470.height,true,0);
               _loc4_.bitmap.copyPixels(var_470,var_470.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_802.width,var_802.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_649.width,var_649.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_649,var_649.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_390.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_390.numGridItems)
         {
            return;
         }
         select(var_390.getGridItemAt(param1) as IWindowContainer);
      }
