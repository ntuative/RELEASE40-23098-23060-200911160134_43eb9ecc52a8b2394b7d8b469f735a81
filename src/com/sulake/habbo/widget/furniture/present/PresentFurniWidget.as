package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_991:Number = 100;
      
      private static const const_992:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_57,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_71,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_416,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_373,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_379,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_421,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_115,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_57,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_57,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_71,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_416,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_373,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_379,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_421,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_57,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_57:
               hideInterface();
               var_221 = false;
               var_153 = param1.objectId;
               var_192 = param1.text;
               _controller = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_373:
               if(!var_221)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_416:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_71:
               if(!var_221)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_57:
               hideInterface();
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_221 || var_153 == -1 || !_controller)
         {
            return;
         }
         var_221 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_582,var_153);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_991,const_992,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_192 != null)
         {
            _loc4_.caption = var_192;
         }
