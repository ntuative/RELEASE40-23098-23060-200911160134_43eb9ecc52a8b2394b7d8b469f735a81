package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_884:ICheckBoxWindow;
      ...
      private var var_702:IDropMenuWindow;
      
      private var var_580:ICheckBoxWindow;
      
      private var var_55:IFrameWindow;
      
      private var var_885:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_53,WindowTracker.const_624,_data.flatId),var_55,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_369);
         if(param1.flatId != var_369)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_369);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new UserInfoFrameCtrl(var_53,_data.ownerId),var_55,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_580.isSelected);
         var_53.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1166,_loc2_,var_370.text,"",""));
         if(false)
         {
            var_53.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_884.isSelected,var_885.isSelected,var_580.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1211);
      }
      ...
      public function populate() : void
      {
         ...
         var_702 = IDropMenuWindow(var_55.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_702);
         var_702.procedure = onSelectTemplate;
         var_580 = ICheckBoxWindow(var_55.findChildByName("kick_check"));
         var_884 = ICheckBoxWindow(var_55.findChildByName("lock_check"));
         var_885 = ICheckBoxWindow(var_55.findChildByName("changename_check"));
         ...
         var_53.disableButton(var_53.initMsg.bobbaFilterPermission,var_55,"bobba_filter_but");
      ...
      {
         var_55 = IFrameWindow(var_53.getXmlWindow("roomtool_frame"));
         var_53.messageHandler.addRoomInfoListener(this);
         var_53.connection.send(new GetModeratorRoomInfoMessageComposer(var_369));
         Logger.log("BEGINNING TO SHOW: " + var_369);
      }
   }
}
