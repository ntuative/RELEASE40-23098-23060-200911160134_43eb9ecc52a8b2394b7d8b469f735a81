package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_392:UserInfoCtrl;
      
      private var var_64:ModerationManager;
      
      private var var_981:UserInfoCtrl;
      
      private var var_157:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.releaseBundle(var_157.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_46,onResized);
         }
         ...
         var_392 = new UserInfoCtrl(_window,var_64);
         var_981 = new UserInfoCtrl(_window,var_64);
         var_392.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_157.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_981.load(_loc3_,var_157.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_157.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_157.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_157.getHighestPriorityIssue().issueId;
         var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_64,WindowTracker.const_790,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_64 != null && false && var_157 != null)
         {
            var_64.issueManager.removeHandler(var_157.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_392 = new UserInfoCtrl(_window,var_64);
            var_392.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_157.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_64.issueManager.closeBundle(var_157.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1296;
      }
   }
}
