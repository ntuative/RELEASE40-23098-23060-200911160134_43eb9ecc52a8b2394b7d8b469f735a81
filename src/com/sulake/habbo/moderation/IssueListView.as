package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         _list = param3;
         var_1040 = param4;
         var_1472 = var_551.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1472 == null)
            {
               return;
            }
            _loc2_ = var_1472.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = _list.width;
            _loc2_.color = !!(_loc4_++ % 2) ? 4288861930 : uint(4294967295);
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_551.assets.getAssetByName(_loc8_) as BitmapDataAsset;
