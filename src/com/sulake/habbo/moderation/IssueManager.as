package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_833:String = "issue_bundle_open";
      
      public static const const_528:String = "issue_bundle_my";
      
      public static const const_819:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_143 = new Map();
         var_812 = new Map();
         var_551 = new IssueBrowser(this,var_64.windowManager,var_64.assets);
         var_656 = [];
         var_811 = [];
         var_980 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_980.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_143)
         {
            switch(param1)
            {
               case const_833:
                  ...
                  break;
               case const_528:
                  if(_loc4_.state == IssueMessageData.const_430 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_656 = var_656.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_812.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_812.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1136)
         {
            var_161.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_143)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_812.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_812.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_143)
         {
            ...
            _loc8_ = var_811.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_980.remove(param1);
         var_980.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_430 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_980.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_64.soundManager.playSound(HabboSoundTypesEnum.const_814);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_812.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_143.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_430 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
