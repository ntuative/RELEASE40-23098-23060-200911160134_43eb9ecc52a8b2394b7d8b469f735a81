package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1988:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1988.clone());
      ...
      {
         var_1988 = IWindowContainer(var_53.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1195;
      }
   }
}
