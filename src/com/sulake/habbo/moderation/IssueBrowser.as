package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1331:IIssueBrowserView;
      
      private const const_1550:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1548:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1332:IIssueBrowserView;
      
      private const const_1573:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1549:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_208:ITabContextWindow;
      
      private var var_1330:PickedIssuesView;
      
      private var var_311:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_208 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_208.numTabItems)
            {
               _loc5_ = var_208.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_53,onTabSelected);
               _loc6_++;
            }
         }
         var_208 = _window.findChildByName("tab_context") as ITabContextWindow;
         if(var_208 == null || true)
         {
            return;
         }
         var _loc1_:ISelectableWindow = var_208.selector.getSelectableByName("open_issues");
         var_208.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_311.view.width = var_208.container.width;
         var_311.view.height = var_208.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1549:
               if(var_1332 == null)
               {
                  var_1332 = new MyIssuesView(issueManager,this,var_208.container);
               }
               return var_1332;
            case const_1550:
               if(var_1331 == null)
               {
                  var_1331 = new OpenIssuesView(issueManager,this,var_208.container);
               }
               return var_1331;
            case const_1548:
               if(var_1330 == null)
               {
                  var_1330 = new PickedIssuesView(issueManager,this,var_208.container);
               }
               return var_1330;
            default:
               return null;
