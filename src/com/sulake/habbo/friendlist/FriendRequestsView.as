package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1363:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_305 && _loc4_.state != FriendRequest.const_288)
            {
      ...
      {
         var_1395 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1394 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1394.procedure = onDismissAllButtonClick;
         var_1395.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_95,param2);
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_288;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_143)
         {
         ...
         else if(param1.state == FriendRequest.const_288)
         {
            _friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_792)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1395,_loc1_);
         setEnabled(var_1394,_loc1_);
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         _list.removeListItem(param1.view);
         refreshButtons();
      }
