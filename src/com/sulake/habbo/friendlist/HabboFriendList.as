package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_165:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1672:IAvatarRenderManager;
      
      private var var_1449:AvatarSearchResults;
      
      private var var_137:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_824:FriendRequests;
      
      private var var_1835:int;
      
      var var_323:FriendCategories;
      
      private var var_187:IHabboToolbar;
      
      private var var_1996:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_388:FriendListTabs;
      
      private var var_1997:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1448:OpenedToWebPopup;
      ...
      {
         var_1996 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_323 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1449 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         try
         {
            navigateToURL(request,webWindowName);
         }
         catch(e:Error)
         {
         ...
         if(var_1448 == null)
         {
            var_1448 = new OpenedToWebPopup(this);
         }
         var_1448.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_824.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_824.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_388.findTab(FriendListTab.const_95).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_824.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_137 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_323.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_824 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_323.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_323.addCategory(new FriendCategory(FriendCategory.const_980,getText("friendlist.friends")));
         var_323.addCategory(new FriendCategory(FriendCategory.const_425,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_323.addFriend(new Friend(_loc4_));
         }
         var_388 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_323.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_74);
      ...
      {
         var _loc2_:IAvatarImage = var_1672.createAvatarImage(param1,AvatarScaleType.const_93);
         return _loc2_.getCroppedImage(AvatarSetType.const_48);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1672 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_824.method_8(_loc3_);
         var _loc4_:FriendListTab = var_388.findTab(FriendListTab.const_95);
      ...
      {
         var_1997 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_323.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_178.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_388.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_281));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_74:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_312:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH);
                     break;
                  case FriendListTab.const_95:
      ...
      {
         return var_178.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1449.searchReceived(_loc2_.friends,_loc2_.others);
