package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_355:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_792;
         var_355.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_355.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function method_8(param1:FriendRequest) : void
      {
         var_459.push(param1);
         var_355.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            if(false)
            {
               var_355.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
