package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_297:int = 100;
      ...
      {
         return Math.ceil(this.var_225.length / const_297);
      }
      ...
      {
         if(this.var_790 >= this.getPageCount())
         {
            this.var_790 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_790 + 1) * const_297,this.var_225.length);
      }
