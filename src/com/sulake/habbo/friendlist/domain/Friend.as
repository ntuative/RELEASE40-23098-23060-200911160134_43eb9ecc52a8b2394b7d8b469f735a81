package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1433:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_618 = param1.online;
         var_1173 = param1.followingAllowed && param1.online;
         var_540 = param1.figure;
         var_1224 = param1.motto;
         var_1225 = param1.lastAccess;
         var_1132 = param1.categoryId;
         var_1226 = param1.realName;
