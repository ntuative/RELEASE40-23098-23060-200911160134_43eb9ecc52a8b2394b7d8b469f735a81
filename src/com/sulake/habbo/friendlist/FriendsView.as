package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1967:IContainerButtonWindow;
      
      private var var_1970:IContainerButtonWindow;
      
      private var var_1968:IContainerButtonWindow;
      
      private var var_1969:IContainerButtonWindow;
      
      private var var_320:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_320 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1970 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1968 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1967 = initButton("room_invite",onInviteButtonClick,param1);
         var_1969 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _friendList.refreshText(_loc3_,"name",true,param2.name);
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_74,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_320.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess,_loc3_.realName);
            this.var_320.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_28)
         {
            this.var_320.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_237)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_237 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1970,isEnableMinimailButton(_loc1_));
         setEnabled(var_1968,isEnableHomeButton(_loc1_));
         setEnabled(var_1967,isEnableInviteButton(_loc1_));
         setEnabled(var_1969,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = _list.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_74,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_74).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_74,param1);
      }
