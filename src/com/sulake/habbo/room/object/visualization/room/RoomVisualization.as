package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1059:int = 16777215;
      
      public static const const_1270:int = 10066329;
      
      private static const const_1057:int = 13421772;
      
      public static const const_1240:int = 16777215;
      
      private static const const_1367:int = 0;
      
      public static const const_1139:int = 16777215;
      
      private static const const_1056:int = 10066329;
      
      private static const const_1058:int = 10066329;
      
      public static const const_1219:int = 13421772;
      ...
      private var var_967:uint = 16777215;
      ...
      private var var_1890:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_110.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1337;
               }
               if(var_84.getPlaneType(_loc4_) == RoomPlaneData.const_126)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_84.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_230)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_252 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_488);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_588);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_508);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_800);
            if(_loc8_ != var_1890)
            {
               updatePlaneMasks(_loc8_);
               var_1890 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_572));
            if(_loc9_ != var_967)
            {
               var_967 = _loc9_;
            }
            var_1889 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_941));
         ...
         while(_loc4_ < var_110.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_176)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_1889)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_967 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_967 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_967 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_781);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_866);
         var _loc7_:int = 0;
         while(_loc7_ < var_84.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_252,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1058;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1059;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1057;
               }
               else
               {
                  _loc13_.color = const_1056;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_230)
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_110.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_252 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_110.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_252 || _loc3_.type == RoomPlane.const_176 && _loc8_ == RoomPlaneBitmapMaskData.const_210)
                  {
