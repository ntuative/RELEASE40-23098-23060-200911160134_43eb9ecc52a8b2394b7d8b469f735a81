package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1528:int = 16777216;
      
      public static const const_1447:int = 1;
       
      
      private var var_2210:int = 69069;
      
      private var var_1202:int = 1;
      
      private var var_2211:int = 5;
      
      private var var_1440:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1440 * param2);
      }
      ...
      {
         var _loc1_:int = var_2210 * var_1202 + var_2211;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
