package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_579:PlaneMaskVisualization = null;
      
      private var _sizes:Array;
      
      private var var_1549:int = -1;
      
      private var var_354:Map;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            var_579 = var_354.getValue(String(_sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            var_579 = null;
      ...
      {
         if(var_354.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         var_354.add(String(param1),_loc2_);
         _sizes.push(param1);
         _sizes.sort();
         return _loc2_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_354 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_354.length)
            {
               _loc1_ = var_354.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
