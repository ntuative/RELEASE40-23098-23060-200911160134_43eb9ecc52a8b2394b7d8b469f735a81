package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_456:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_456 != null)
         {
            _loc2_ = var_456.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  if(var_38 != null)
                  {
                     if(var_38.width != _loc2_.width || var_38.height != _loc2_.height)
                     {
                        var_38.dispose();
                        var_38 = null;
                     }
                     ...
                     {
                        var_38.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(var_38 == null)
                  {
                  ...
                  _loc3_ = Math.min(var_955,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_955,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_955,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_626[_loc6_ % 0] as IGraphicAsset;
