package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_188:int = 5;
      
      public static const const_193:int = 2;
      
      public static const const_691:int = 0;
      
      public static const const_205:int = 4;
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_46,_loc3_,true,param1);
         _loc2_ = var_46["-1"] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
            while(_loc3_ < var_38.height)
            {
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         while(_loc7_ < -1)
         {
            _loc2_ = var_46[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(false)
         {
            _loc2_ = var_46[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc6_ = _loc2_.getHeight(param1);
               if(_loc6_ > 0)
      ...
      private function renderRepeatNone(param1:IVector3d) : void
      {
         ...
         renderCells(var_46,0,true,param1);
      }
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_46,_loc3_,false,param1);
         _loc2_ = var_46[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         while(_loc9_ < 0)
         {
            _loc2_ = var_46[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         if(_loc6_ + _loc7_ > var_38.height)
         {
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = getCellsHeight(var_46,param1);
         var _loc3_:int = 0;
         if(_loc2_ > var_38.height)
         {
         }
         while(_loc3_ < var_38.height)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1347 == const_691)
         {
            _loc3_ = getCellsHeight(var_46,param2);
            param1 = _loc3_;
         }
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.height == param1 && Vector3d.isEqual(var_717,param2))
               {
                  return var_38;
               }
               var_38.dispose();
         ...
         if(var_38 == null)
         {
            var_38 = new BitmapData(_width,param1,true,16777215);
         }
         var_717.assign(param2);
         if(false)
         {
            return var_38;
         }
      ...
      {
         if(param1 == null || param1.length == 0 || var_38 == null)
         {
            return param2;
         }
         var _loc5_:* = null;
         ...
         while(_loc7_ < param1.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  var_38.copyPixels(_loc6_,_loc6_.rect,new Point(0,param2),_loc6_,null,true);
                  if(param3)
                  {
                     param2 += _loc6_.height;
                  }
                  if(param3 && param2 >= var_38.height || !param3 && param2 <= 0)
                  {
                     return param2;
                  }
               }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_46.length)
            {
               _loc2_ = var_46[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
