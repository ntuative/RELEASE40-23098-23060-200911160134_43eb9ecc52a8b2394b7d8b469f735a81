package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1018:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         _index = param2;
         var_1191 = param3;
         var_1744 = param4 * 0 * 2 / 360;
         var_1378 = param5 * 0 * 2 / 360;
         _height = param6;
         var_738 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1191 * Math.cos(var_738 + var_1378);
         var _loc4_:Number = var_1191 * Math.sin(var_738 + var_1378);
