package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_244.assign(param2);
         var_243 = new Vector3d();
         var_243.assign(param3);
         var_499 = new Vector3d();
         var_499.assign(param2);
         var_500 = new Vector3d();
         var_500.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1640)
         {
            if(!param1)
            {
               var_244.assign(var_499);
               var_243.assign(var_500);
            }
            else
            {
               var_244.assign(var_499);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_75 == null && var_633 != null || var_244 == null || var_243 == null || var_386 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1073)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_891 || _loc4_.y != var_1641 || _loc4_.z != var_1639 || param1.scale != var_1637))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_633);
               _loc7_ = _loc6_.z;
