package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      override public function update() : void
      {
         ...
         {
            _loc1_ = object.getModelController().getString(RoomObjectVariableEnum.const_138);
            if(_loc1_ != null && _loc1_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_138,"");
               dispatchColorUpdateEvent(_loc1_);
            }
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_117,_loc3_,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(var_1146)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REMOVE_DIMMER,_loc1_,_loc2_);
