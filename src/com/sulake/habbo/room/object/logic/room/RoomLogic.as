package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1494:int = 255;
      
      private var var_1495:int = 255;
      
      private var var_1271:uint = 16777215;
      
      private var var_1015:uint = 16777215;
      
      protected var var_84:RoomPlaneParser = null;
      
      private var var_848:int = 0;
      
      private var var_1056:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_682:
                  _loc2_.setString(RoomObjectVariableEnum.const_588,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_621:
                  _loc2_.setString(RoomObjectVariableEnum.const_488,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_551:
                  _loc2_.setString(RoomObjectVariableEnum.const_508,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_349:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_210)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_702:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_800,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_941,int(_loc5_.bgOnly));
            var_1271 = _color;
            var_1494 = var_1056;
            var_1015 = _loc11_;
            var_1495 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_781,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_572,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_84.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_97,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1291,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1173,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1275,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_97,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_139 || _loc13_ == RoomPlaneData.const_230)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_848)
         {
            ...
            {
               _loc6_ = var_1271 >> 16 & 255;
               _loc7_ = var_1271 >> 8 & 255;
               _loc8_ = var_1271 & 255;
               _loc9_ = var_1015 >> 16 & 255;
               _loc10_ = var_1015 >> 8 & 255;
               _loc11_ = var_1015 & 255;
               _loc12_ = (_loc1_ - var_848) / var_1493;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1494 + (var_1495 - var_1494) * _loc12_;
               _color = _loc2_;
               var_1056 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_572,_loc2_);
         }
      }
   }
}
