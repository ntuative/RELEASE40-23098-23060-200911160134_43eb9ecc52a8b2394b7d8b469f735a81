package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_428,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_639,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_428,Number(false));
         var_842 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_767:
                  _loc2_.setString(RoomObjectVariableEnum.const_325,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_639,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_428,Number(true));
                  var_943 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_775);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_345)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_639);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_249,_loc5_,_loc6_,_loc7_));
