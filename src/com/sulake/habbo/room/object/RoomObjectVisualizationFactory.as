package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_729:IAvatarRenderManager = null;
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_435.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         switch(param2)
         {
            case RoomObjectVisualizationEnum.const_802:
            case RoomObjectVisualizationEnum.const_257:
            case RoomObjectVisualizationEnum.const_233:
               _loc5_ = PublicRoomVisualizationData;
               break;
            case RoomObjectVisualizationEnum.const_158:
               _loc5_ = RoomVisualizationData;
               break;
            case RoomObjectVisualizationEnum.const_104:
            ...
            case RoomObjectVisualizationEnum.const_226:
            case RoomObjectVisualizationEnum.const_828:
            case RoomObjectVisualizationEnum.const_805:
            case RoomObjectVisualizationEnum.const_240:
            case RoomObjectVisualizationEnum.const_836:
            case RoomObjectVisualizationEnum.const_773:
            ...
            case RoomObjectVisualizationEnum.const_258:
               _loc5_ = FurnitureVisualizationData;
               break;
            case RoomObjectVisualizationEnum.const_218:
               _loc5_ = AnimatedFurnitureVisualizationData;
         }
         if(_loc5_ == null)
         {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_729;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_729;
            }
            var_435.add(param1,_loc6_);
            return _loc6_;
         }
         return null;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_435 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_435.length)
            {
               _loc1_ = var_435.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_729 = param2 as IAvatarRenderManager;
      }
