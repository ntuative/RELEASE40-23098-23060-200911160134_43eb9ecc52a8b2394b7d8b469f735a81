package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_746:String = "selection_arrow";
      
      private static const const_745:String = "tile_cursor";
      
      private static const const_267:String = "RCL_PUBLICROOM_";
      
      private static const const_476:String = "wall_place_holder";
      
      private static const const_1031:int = 2;
      
      private static const const_333:String = "place_holder";
      
      private static const const_1032:String = const_333;
      
      private static const const_1362:int = 0;
      
      private static const const_744:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_647:String = "RCL_LOADER_READY";
      ...
      private var var_941:IEventDispatcher = null;
      
      private var _publicRooms:Map = null;
      
      private var var_451:Map = null;
      
      private var var_523:Map = null;
      ...
      private var var_167:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_615 = [];
         var_614 = [];
         var_1796 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1797 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_375 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_523.getValue(param1) as String;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_267 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_104 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_167 != null && var_167.hasWorldType(const_267 + param1))
         {
            return var_167.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_523.add(_loc10_,_loc11_);
                              if(var_614.indexOf(_loc14_) < 0)
                              {
                                 var_614.push(_loc14_);
                              }
                           }
                           _loc16_ = var_451.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_451.remove(_loc14_);
                              var_451.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_375 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_375.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return [const_333,const_476,ROOM_CONTENT,const_745,const_746];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_375.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_524.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_375.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
            }
            return int(var_451.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1796.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_158 && _loc5_ != RoomObjectLogicEnum.const_104)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_614.indexOf(param1) >= 0)
         {
            return const_476;
         }
         if(var_167 != null && (var_167.type == param1 || var_167.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1032;
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_376 != null)
         {
            _loc2_ = var_376.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1131);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_523.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1797.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_167 != null && (var_167.type == param1 || var_167.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_52;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_52;
         ...
         {
            return RoomObjectCategoryEnum.const_242;
         }
         return RoomObjectCategoryEnum.const_178;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1792)
         {
            ...
            if(var_941 != null)
            {
               var_941.dispatchEvent(new Event(const_647));
            }
         }
      }
      
      public function method_11(param1:String) : Number
      {
         if(var_167 != null)
         {
            return var_167.getWorldHeightScale(const_267 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc3_ == RoomObjectCategoryEnum.const_29)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_941 = param1;
            var_1798 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1793 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1795 = param2.getKey("public.room.dynamic.download.url","");
            var_1794 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_744;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_376 != null)
         {
            var_376.remove(param1);
            var_376.add(param1,param2);
         }
         if(var_377 != null)
         {
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_158 && _loc5_ != RoomObjectVisualizationEnum.const_104)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_362.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_267 + param1) == RoomObjectCategoryEnum.const_52)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_167 = _publicRooms.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_468,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_167 != null)
         {
            return var_167.getWorldScale(const_267 + param1);
         }
         return 32;
      }
