package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1904:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1311:ILogger;
      
      private var var_1182:String;
      
      private var var_1903:String;
      
      private const const_1369:String = "fuselogin";
      
      private var var_613:ICoreCommunicationManager;
      
      private var var_469:IKeyExchange;
      ...
      private var var_77:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_974)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_18);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_290:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_952:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_929:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_925:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1902)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_645 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_645);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_22);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1182,var_1903));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1369,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_469.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_469.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1904);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1369,"/");
      ...
      {
         var_645 = _habboConfiguration.getKey("sso.ticket",null);
         var_1182 = _habboConfiguration.getKey("flash.client.url","");
         var_1903 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_172 == null)
         {
         ...
         if(var_645 != null)
         {
            var_77.mode = HabboConnectionType.const_447;
            var_77.initConnection(HabboConnectionType.const_265);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1311 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_77 = param2 as IHabboCommunicationManager;
            _loc3_ = var_77.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_77.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_77.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_77.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_77.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_77.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_77.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_77.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_77.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_77.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_77.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_77.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_77.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_77.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_644);
            _loc3_ = new InitCryptoMessageComposer(var_77.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1904 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_77.mode)
         {
            case HabboConnectionType.const_447:
               _loc6_ = "";
               ...
               var_975 = _loc4_;
               var_172.loadBannerImage(_loc7_ + "?token=" + var_975,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1241:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1337:
               var_973 = generateRandomHexString(30);
               var_469 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_469.init(var_973);
               _loc8_ = var_469.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_975);
         ...
         var _loc9_:IConnection = var_77.getHabboMainConnection(null);
         ...
         var_469 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_973 = generateRandomHexString(30);
            var_469.init(var_973);
            _loc12_ = var_469.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_14);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_11,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_94,onRoomSessionEnded);
      }
