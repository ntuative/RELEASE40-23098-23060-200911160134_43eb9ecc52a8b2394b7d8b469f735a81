package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_580:String = "InitConnection";
      ...
      private var var_341:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_121:SSOTicket;
      ...
      {
         var_341.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_341.shockwaveClientUrl = var_121.shockwaveClientUrl;
         var_341.ssoTicket = var_121.ticket;
         var_121.removeEventListener(SSOTicket.const_273,onParsedTicketSuccess);
         var_121.removeEventListener(SSOTicket.const_264,onParsedTicketFailure);
         var_121 = null;
         dispatchEvent(new Event(const_580));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1369,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_341 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_341.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_316,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_341.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_98,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1369,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_341.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_341.habboCommunication.habboWebLogin(name,password);
         var_121 = new SSOTicket(var_341.assets,_loc2_,_loc1_);
         var_121.addEventListener(SSOTicket.const_273,onParsedTicketSuccess);
         var_121.addEventListener(SSOTicket.const_264,onParsedTicketFailure);
      }
