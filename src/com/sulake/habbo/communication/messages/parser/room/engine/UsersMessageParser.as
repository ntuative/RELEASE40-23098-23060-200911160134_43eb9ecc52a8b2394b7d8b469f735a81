package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public static function method_13(param1:String) : String
      {
         var _loc8_:int = 0;
         var _loc9_:int = 0;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_402;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_295;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_901;
               ...
               _loc14_.sex = UserMessageData.const_835;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1295;
         }
         return UserMessageData.const_835;
      }
