package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_278:IGridItem;
      
      protected var var_861:IItemGridWindow;
      
      protected var var_1286:XML;
      
      private var var_1480:Map;
      
      private var var_841:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_861 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      private function populateGridItems() : void
      {
         ...
         var_1286 = _loc1_.content as XML;
         var _loc2_:int = 0;
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1286) as IWindowContainer;
         var_861.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         var _loc3_:String = var_1480.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_93);
         var _loc5_:IBitmapWrapperWindow = _loc2_.findChildByName("image") as IBitmapWrapperWindow;
         _loc5_.bitmap = new BitmapData(_loc5_.width,_loc5_.height,true,16777215);
         _loc4_.setDirection(AvatarSetType.const_37,4);
         var _loc6_:BitmapData = _loc4_.getImage(AvatarSetType.const_37);
      ...
      {
         var _loc1_:String = var_1480.getValue(var_841.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         _loc2_.setDirection(AvatarSetType.const_37,4);
         setPreviewImage(_loc2_.getImage(AvatarSetType.const_37));
      }
      
      private function onBuyButtonEvent(param1:WindowEvent) : void
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_841,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_841.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_841.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_841.localizationId);
