package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_539[var_963] as Array;
      ...
      {
         var _loc2_:Offer = var_539[var_963][var_1880];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_366 || _loc1_.pricingModel == Offer.const_417)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_136 || _loc3_.productType == ProductTypeEnum.const_150)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_962.indexOf(_loc5_) == -1)
                        {
                           var_962.push(_loc5_);
                           var_539.push(new Array());
                        }
                        _loc6_ = var_962.indexOf(_loc5_);
                        (var_539[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_539)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_539)
         {
            if(var_1880 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1880] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_963 = var_861.getGridItemIndex(param1.view);
