package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1131:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_522 != null)
         {
            var_522.visible = false;
            var_522.destroyGridItems();
         }
         if(var_1131 != null)
         {
            var_1131.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1115.text = "${" + _loc3_.name + "}";
            var_1116.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1115.text = "${" + _loc2_.localizationId + "}";
            var_1116.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            {
               case Offer.const_393:
                  _loc4_ = var_1130.clone();
                  if(var_522 != null)
                  {
                     var_522.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_522,var_1131,var_1286);
                  }
                  break;
               case Offer.const_366:
               case Offer.const_417:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_274:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_48,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_311,AvatarAction.const_719);
                              _loc13_.appendAction(AvatarAction.const_631,_loc6_.productClassId);
      ...
      {
         var_1115 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1116 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1390 = new Point(var_88.x,var_88.y);
         var_522 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1131 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_522 == null)
         {
         ...
         var_1130 = _loc2_.content as BitmapData;
