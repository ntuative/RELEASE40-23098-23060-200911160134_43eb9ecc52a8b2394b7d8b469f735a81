package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1004:ITextFieldWindow;
      ...
      {
         super.init();
         var_1004 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1004 != null)
         {
            var_1004.addEventListener(WindowKeyboardEvent.const_987,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1004.text));
      }
   }
}
