package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_865:IButtonWindow;
      
      private var var_866:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_865 != null)
         {
            var_865.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_866 != null)
         {
            var_866.removeEventListener(WindowKeyboardEvent.const_125,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_865 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_865 != null)
         {
            var_865.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_866 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_866 != null)
         {
            var_866.addEventListener(WindowKeyboardEvent.const_125,windowKeyEventProcessor);
         }
      }
