package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1345:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1274:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_694:String;
      
      private var var_1046:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_745:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_694);
      }
      ...
      {
         var _loc2_:String = const_1345 + param1;
         ...
         var_1274 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1274) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1046;
            _loc2_.init();
         }
         var_1046.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1046.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_694);
      }
