package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_674:PurchaseConfirmationDialog;
      
      private var var_754:IHabboSoundManager;
      
      private var var_340:ICatalogViewer;
      ...
      private var var_403:ICatalogNavigator;
      ...
      {
         return var_520.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_203.credits = _loc3_.balance;
         updatePurse();
         if(!var_2054 && var_754 != null)
         {
            var_754.playSound(HabboSoundTypesEnum.const_891);
         }
         var_2054 = false;
      }
      ...
      {
         return var_520.getFurnitureData(param1);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               var_1252 = param1.session.isPrivateRoom;
               if(var_91 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_403 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_203.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_203.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_674 == null)
            {
               var_674 = new PurchaseConfirmationDialog(_localization);
            }
            var_674.showOffer(this,param1,param2,param3);
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            toggleCatalog(true);
            var_403.openPage(param1);
         }
      }
      
      private function setHabboToolbarIcon() : void
      {
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_403.buildCatalogIndex(_loc2_);
         if(var_998 != "")
         {
            var_403.openPage(var_998);
            var_998 = "";
         }
         else
         {
            var_403.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_340 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_340.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_203.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2053 && var_754 != null)
         {
            var_754.playSound(HabboSoundTypesEnum.const_981);
         }
         var_2053 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_203.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_203.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_203.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_203.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_340.getCurrentLayoutCode();
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_340.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_340.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_340 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
      
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var _loc3_:IRoomSessionManager = IRoomSessionManager(param2);
         _loc3_.events.addEventListener(RoomSessionEvent.const_87,onRoomSessionEvent);
