package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_995:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1326:XML;
      
      private static var var_1327:XML;
      ...
      private var var_1325:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1325 == 4294967295)
            {
               var_1325 = _loc1_.color;
            }
            _loc1_.color = const_995;
         }
      }
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_30,onIconImageReady);
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1102;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1326) as IWindowContainer;
         }
         else
         {
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(_list);
            }
         }
         if(_list != null)
         {
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1327) as IItemListWindow;
         if(_list == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1125;
            }
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(_list);
            }
         }
         if(_list != null)
         {
