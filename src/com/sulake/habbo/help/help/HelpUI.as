package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1365:int = 0;
      
      private static const const_1366:int = 0;
      ...
      private var var_383:IWindowContainer;
      ...
      private var var_1868:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23098-23060-200911160109");
         var_187 = param5;
         var_118 = new Map();
         var_118.add(HabboHelpViewEnum.const_1235,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_131,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_438,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_260,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_192,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_563,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_284,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_630,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_181,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_118.add(HabboHelpViewEnum.const_648,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_262 == HabboHelpViewEnum.const_131 || false)
         {
            return;
         }
         if(var_383 == null)
         {
            ...
            var_383 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_383 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_383 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_383 as IWindow);
      ...
      {
         return var_118.getValue(var_262);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_118.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_118.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1869 = param1;
         var _loc2_:IHelpViewController = var_118.getValue(HabboHelpViewEnum.const_131) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_181:
               showUI(HabboHelpViewEnum.const_181);
               break;
            case CallForHelpResultEnum.const_906:
               showUI(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(var_262 == HabboHelpViewEnum.const_131)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_383.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1414;
         _window.width = _loc1_.width + var_1413;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_118.length)
         {
            _loc3_ = var_118.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_262);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_187 != null)
            {
               var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_695));
      }
