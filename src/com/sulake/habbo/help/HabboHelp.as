package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1700:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_128:TutorialUI;
      
      private var var_1360:IHabboLocalizationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_60:HelpUI;
      
      private var var_1359:IHabboConfigurationManager;
      
      private var var_187:IHabboToolbar;
      
      private var var_613:IHabboCommunicationManager;
      
      private var var_728:FaqIndex;
      
      private var var_1699:String = "";
      
      private var var_1358:IncomingMessages;
      
      private var var_1092:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1092 = new CallForHelpData();
         var_1700 = new UserRegistry();
         super(param1,param2,param3);
         _assetLibrary = param3;
         var_728 = new FaqIndex();
      ...
      {
         var_1092.reportedUserId = param1;
         var_1092.reportedUserName = param2;
         var_60.showUI(HabboHelpViewEnum.const_284);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_60 = new HelpUI(this,_assetLibrary,_windowManager,var_1360,var_187);
         }
         return var_60 != null;
      }
      ...
      {
         var_1360 = IHabboLocalizationManager(param2);
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1358 = new IncomingMessages(this,var_613);
      ...
      {
         var_1359 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_1359.getKey(param1,param2,param3);
      }
   }
}
