package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onChangeUserNameResult(param1:IMessageEvent) : void
      {
         if(var_43 == null || true)
         {
            return;
         }
         var_43.tutorialUI.onChangeUserNameResult(param1 as ChangeUserNameResultMessageEvent);
      }
      
      private function onCheckUserNameResult(param1:IMessageEvent) : void
      {
         if(var_43 == null || true)
         {
            return;
         }
         var_43.tutorialUI.onCheckUserNameResult(param1 as CheckUserNameResultMessageEvent);
      }
      
      private function onFaqText(param1:IMessageEvent) : void
      {
         var _loc2_:FaqTextMessageParser = FaqTextMessageEvent(param1).getParser();
         var _loc3_:FaqIndex = var_43.getFaq();
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            var_43.tellUI(HabboHelpViewEnum.const_192,_loc4_);
         }
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         var_43.ownUserName = _loc2_.newName;
         if(true)
         {
            return;
         }
         var_43.tutorialUI.onUserNameChanged(_loc2_.newName);
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            var_43.enableCallForGuideBotUI();
         }
         else
         {
            var_43.disableCallForGuideBotUI();
         }
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         var_43.showCallForHelpResult(_loc4_);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_260,_loc6_);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         var_43.tutorialUI.onUserChanged();
      }
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         var_43.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_43.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + getCloseReasonKey(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_131);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _userId = _loc2_.id;
         var_43.ownUserName = _loc2_.name;
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         var_43.showUI(HabboHelpViewEnum.const_284);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_43.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         var_43.userRegistry.registerRoom(var_43.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         var_43.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_438);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_563);
         var_43.tellUI(HabboHelpViewEnum.const_563,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_402)
            {
               var_43.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
         ...
         var_43.tellUI(HabboHelpViewEnum.const_648);
      }
