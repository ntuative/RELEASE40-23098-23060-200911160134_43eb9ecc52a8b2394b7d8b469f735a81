package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_53.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_43,onShowMenuEvent);
         var_53.prepareForTutorial();
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_43)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_53.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_470));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_490 = var_53.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_490.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_53.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.MEMENU_ARROW,var_490));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_53.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_43,onShowMenuEvent);
      }
   }
}
