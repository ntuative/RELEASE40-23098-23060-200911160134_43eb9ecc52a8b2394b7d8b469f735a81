package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1765 = new RoomThumbnailRenderer(param1);
         var_905 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_166,var_115.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_166.findChildByName("roomowner"));
         if(true)
         {
            _loc1_.procedure = onOwnerName;
            _loc1_.setParamFlag(HabboWindowParam.const_35,true);
            _loc1_.underline = true;
         }
         else
         {
            _loc1_.procedure = null;
            _loc1_.setParamFlag(HabboWindowParam.const_35,false);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_166.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_905.refreshTags(_loc1_,var_115.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1765.refreshThumbnail(_loc1_,var_115.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_166 == null)
         {
            var_166 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_166.visible = true;
         Util.hideChildren(var_166);
         refreshRoomName(var_166,var_115);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_166,!true ? getEventCtg(var_115.categoryId) : getRoomCtg(var_115.categoryId));
         refreshRoomDesc(var_166,var_115);
         refreshExtraCont();
         refreshInfo(var_166,"trading_allowed",var_115.allowTrading);
         refreshInfo(var_166,"doormode_doorbell",false);
         refreshInfo(var_166,"doormode_password",false);
         Util.moveChildrenToColumn(var_166,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_166.height = Util.getLowestPoint(var_166);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_194,Tabs.const_195,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
