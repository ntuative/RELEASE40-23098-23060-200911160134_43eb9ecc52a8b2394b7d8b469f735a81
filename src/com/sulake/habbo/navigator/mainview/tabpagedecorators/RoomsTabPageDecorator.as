package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_471:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_471 == null ? 0 : int(var_471.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_271);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_709);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_271,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_471 == null)
         {
            var_471 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_471.procedure = onChangeFilter;
