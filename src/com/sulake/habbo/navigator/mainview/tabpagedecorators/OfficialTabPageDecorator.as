package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class OfficialTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_253,Tabs.const_445,"" + _loc2_,MainViewCtrl.const_523);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_455 == null)
         {
            var_455 = IDropMenuWindow(_loc3_.findChildByName("officialSubNavi"));
            var_455.procedure = onChangeNavi;
            prepareNavi();
         }
         _loc3_.visible = true;
      }
