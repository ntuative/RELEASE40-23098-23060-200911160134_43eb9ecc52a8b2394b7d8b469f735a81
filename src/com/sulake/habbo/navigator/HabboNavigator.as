package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2234:Dictionary;
      ...
      private var var_1938:ISessionDataManager;
      
      private var var_1939:RoomCreateViewCtrl;
      
      private var var_1765:RoomThumbnailRenderer;
      
      private var var_187:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1199:RoomInfoViewCtrl;
      
      private var var_80:IHabboCatalog;
      
      private var var_388:Tabs;
      
      private var var_472:MainViewCtrl;
      
      private var var_1937:Array;
      
      private var var_928:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_472 = new MainViewCtrl(this);
         var_1199 = new RoomInfoViewCtrl(this);
         var_1939 = new RoomCreateViewCtrl(this);
         var_1765 = new RoomThumbnailRenderer(this);
         var_928 = new GuestRoomPasswordInput(this);
         var_331 = new GuestRoomDoorbell(this);
         var_388 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_472.startSearch(Tabs.const_194,Tabs.const_294,param1);
         var_472.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_178.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1938 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_472.startSearch(Tabs.const_261,Tabs.const_183);
         var_388.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_472.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
