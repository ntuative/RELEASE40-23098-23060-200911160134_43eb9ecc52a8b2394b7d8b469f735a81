package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_183);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Flat created: " + _loc2_.flatId + ", " + _loc2_.flatName);
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         Logger.log("GOT USER FLAT CATS: " + _loc2_.nodes.length);
      }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_147)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_102)
            {
