package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2141:BitmapData;
      
      protected var var_860:Boolean;
      
      protected var var_2131:Boolean;
      
      protected var var_1959:int;
      
      protected var var_2140:String;
      
      protected var var_412:int = 0;
      ...
      protected var var_350:BitmapData;
      
      private const const_1377:Number = 0.2;
      
      protected var var_1285:Boolean;
      
      private const const_1378:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_509)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2140 == FurniModel.const_40)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1287);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1285 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2141;
               _loc5_.visible = true;
            }
            else
            {
