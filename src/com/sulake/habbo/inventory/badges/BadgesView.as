package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_92:BadgesModel;
      
      private var var_950:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_950 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_950.procedure = inactiveGridEventProc;
         var_951 = _view.findChildByName("active_items") as IItemGridWindow;
         var_951.procedure = activeGridEventProc;
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "wearBadge_button":
                  _loc3_ = var_92.getSelectedBadge();
                  if(_loc3_ != null)
                  {
                     var_92.toggleBadgeWearing(_loc3_.type);
                  }
            }
         }
      }
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_951.getGridItemIndex(param1.window);
            _loc4_ = var_92.getBadgeFromActive(_loc3_);
            if(_loc4_ != null)
            {
               var_92.setBadgeSelected(_loc4_.type);
            }
         }
      }
      ...
      private function updateActionView() : void
      {
         ...
         var _loc2_:Badge = var_92.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
            setBadgeName(null);
         ...
         else
         {
            ...
            _loc3_ = var_92.getBadges(1);
            if(_loc3_ != null && _loc3_.length >= var_92.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      private function updateListViews() : void
      {
         ...
         var_950.removeGridItems();
         var_951.removeGridItems();
         var _loc1_:Array = var_92.getBadges(0);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_950.addGridItem(_loc2_.window);
               _loc2_.window.procedure = inactiveGridEventProc;
            }
            _loc3_++;
         }
         var _loc4_:Array = var_92.getBadges(1);
         _loc3_ = 0;
         while(_loc3_ < _loc4_.length)
         {
            _loc2_ = _loc4_[_loc3_] as Badge;
            var_951.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_950.getGridItemIndex(param1.window);
            _loc4_ = var_92.getBadgeFromInactive(_loc3_);
            if(_loc4_ != null)
            {
               var_92.setBadgeSelected(_loc4_.type);
            }
