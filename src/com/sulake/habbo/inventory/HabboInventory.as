package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1553:int = 500;
      ...
      private var var_1358:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_56.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_56.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_87,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_374,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_56.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_374:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_56.getValue(InventoryCategory.const_585));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_56.getValue(InventoryCategory.const_79));
      }
      ...
      {
         var_203.clubPeriods = param1;
         var_203.clubDays = param2;
         var_203.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_914));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_56.getValue(InventoryCategory.const_219));
      }
      ...
      {
         var _loc2_:IInventoryModel = var_56.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1553);
         }
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_56.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         return AchievementsModel(var_56.getValue(InventoryCategory.const_279));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_726.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_726.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_56.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_56.length)
         {
            _loc3_ = var_56.getWithIndex(_loc2_) as IInventoryModel;
      ...
      {
         return TradingModel(var_56.getValue(InventorySubCategory.const_259));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_520 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_726.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1358 = new IncomingMessages(this);
      ...
      {
         return var_203.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_203.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_56.getValue(InventoryCategory.const_245));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_87,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_94,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_374,roomSessionEventHandler);
         _view = new InventoryMainView(this,_windowManager,_assetLibrary);
         var_56 = new Map();
         var _loc3_:FurniModel = new FurniModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization,_config);
         var_56.add(InventoryCategory.const_79,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_520);
         var_56.add(InventoryCategory.const_245,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_56.add(InventoryCategory.const_585,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_520);
         var_56.add(InventoryCategory.const_279,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.const_259,_loc7_);
         var _loc8_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.RECYCLER,_loc8_);
         var _loc9_:PetsModel = new PetsModel(this,_windowManager,_communication,_assetLibrary,_localization,_roomEngine,_avatarRenderer);
         var_56.add(InventoryCategory.const_219,_loc9_);
