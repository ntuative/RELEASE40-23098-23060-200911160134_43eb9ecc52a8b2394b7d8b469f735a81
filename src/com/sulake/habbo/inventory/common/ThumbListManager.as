package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_889:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_498 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_498.width;
         var_95 = var_498.height;
         var_890 = param5;
         var_708 = param6;
         var_210 = Math.floor(var_890 / _thumbWidth);
         var_32 = new BitmapData(var_890,var_708);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_210 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_210 - param1.x - 1;
         ...
         if(var_32.height < var_708)
         {
            _loc12_ = new BitmapData(var_32.width,var_708);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_498.width,var_498.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_498.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_498,var_498.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_889 != null)
         {
            _loc1_ = var_889.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_423 = resolveRowCountFromList();
         if(var_423 == 0)
         {
            var_32 = new BitmapData(var_890,var_708);
            return;
         }
         var_32 = new BitmapData(Math.max(var_210 * _thumbWidth,var_890),Math.max(var_423 * var_95,var_708),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_423)
         {
            _loc4_ = 0;
            while(_loc4_ < var_210)
            {
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_210 && var_32.height < _loc3_.y * var_95)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_210 - 1),var_95);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_210 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_95),null,null,true);
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_210 - 1),0 - var_95);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_210));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_210);
         var _loc3_:int = param1 % var_210;
         return new Point(_loc3_,_loc2_);
      }
