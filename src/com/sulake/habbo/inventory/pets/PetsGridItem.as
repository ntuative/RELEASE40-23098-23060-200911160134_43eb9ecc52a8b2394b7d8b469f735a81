package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc8_:BitmapData = _loc7_.getCroppedImage(AvatarSetType.const_48);
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_42:
               var_1011.setSelectedGridItem(this);
               var_847 = true;
               break;
            case WindowMouseEvent.const_98:
               var_847 = false;
               break;
            case WindowMouseEvent.const_28:
               ...
               {
                  var_847 = false;
                  var_1011.placePetToRoom(var_1159.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1555) : uint(const_1554);
      }
