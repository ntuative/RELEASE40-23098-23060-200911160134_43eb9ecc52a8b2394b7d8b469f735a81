package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_278:PetsGridItem;
      ...
      private var var_429:IItemGridWindow;
      
      private var var_92:PetsModel;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_429 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_502 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_502.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_278 != null)
         {
            var_278.setSelected(false);
         }
         var_278 = param1;
         if(var_278 != null)
         {
            var_278.setSelected(true);
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_53)
         {
            ...
            {
               case "tab_floor":
                  var_92.switchCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  var_92.switchCategory(FurniModel.const_41);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_278.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateGrid() : void
      {
         ...
         var_429.removeGridItems();
         var_502.reset();
         var _loc1_:Map = var_92.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var_92.placePetToRoom(param1,param2);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = var_502.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_429.removeGridItem(_loc2_.window);
         if(var_278 == _loc2_)
         {
            var_278 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_502.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_429.addGridItem(_loc2_.window);
            var_502.add(param1.id,_loc2_);
            if(var_278 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            _loc8_ = var_92.roomSession.arePetsAllowed;
            _loc9_ = var_92.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
