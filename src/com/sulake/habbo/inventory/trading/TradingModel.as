package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_296:uint = 2;
      
      public static const const_434:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_232:uint = 3;
      
      public static const const_162:uint = 1;
      
      public static const const_153:uint = 0;
      
      public static const const_1234:uint = 9;
      ...
      private var var_51:TradingView;
      ...
      public function TradingModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager)
      {
         ...
         var_51 = new TradingView(this,param2,param4,param5,param6);
      }
      ...
      {
         var_51.updateItemImage(param1,param2);
      }
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_448 = false;
         var_608 = false;
         var_51.updateItemList(var_609);
         var_51.updateItemList(var_1125);
         var_51.updateUserInterface();
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_51.alertPopup(TradingView.const_936);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_609)
            {
               var_448 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_608 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_51.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_609)
            {
               var_51.alertPopup(TradingView.const_825);
            }
            close();
         }
         ...
         {
            var_51.showOtherUserNotification("${inventory.trading.warning.others_account_disabled}");
         }
         else if(param1 is TradingYouAreNotAllowedEvent)
         {
            var_51.showOwnUserNotification("${inventory.trading.warning.own_account_disabled}");
         }
         else
         {
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_448 + " OTHER: " + var_608);
         ...
         {
            case const_153:
               if(param1 == const_162 || param1 == const_198)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         return var_51.getWindowContainer();
      }
      ...
      {
         var_51.setMinimized(param1 != InventoryCategory.const_79);
         var_28.updateSubView();
      }
      
      public function startConfirmCountdown() : void
      {
         var_51.startConfirmCountdown();
      }
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         var_509 = true;
         state = const_162;
         var_51.setup(param1,param3,param4,param6);
         var_51.updateItemList(var_609);
         var_51.updateItemList(var_1125);
         var_51.updateUserInterface();
         var_51.clearItemLists();
         var_28.toggleInventoryPage(InventoryCategory.const_79);
      ...
      public function close() : void
      {
         if(var_509)
         {
            if(_state != const_153 && _state != const_198)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_153;
            var_28.toggleInventorySubPage(InventorySubCategory.const_898);
            var_509 = false;
         }
         var_51.setMinimized(false);
      }
