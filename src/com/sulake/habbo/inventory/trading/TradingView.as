package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_738:uint = 4284532064;
      
      private static const const_739:uint = 2577770;
      
      public static const const_892:int = 0;
      ...
      private var var_320:ItemPopupCtrl;
      
      private var var_36:TradingModel;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_320 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
               ...
               case "button_accept":
                  switch(var_36.state)
                  {
                     case TradingModel.const_162:
                        if(var_36.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_892);
                        }
                        if(false)
                        {
                           var_36.requestUnacceptTrading();
                        }
                        else
                        {
                           var_36.requestAcceptTrading();
                        }
                        break;
                     case TradingModel.const_232:
                        param2.disable();
                        var_36.requestConfirmAcceptTrading();
                  }
                  break;
               case "button_cancel":
                  switch(var_36.state)
                  {
                     case TradingModel.const_162:
                        var_36.requestCancelTrading();
                        break;
                     case TradingModel.const_232:
                        var_36.requestConfirmDeclineTrading();
                  }
            }
         }
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_36.requestRemoveItemFromTrading(param2.id);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            _loc3_ = var_36.ownUserItems.getWithIndex(param2.id);
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = _loc3_.peek();
            _loc5_ = var_36.getItemImage(_loc4_);
            _loc6_ = "${roomItem.name." + _loc4_.type + "}";
            if(_loc4_.category == FurniCategory.const_154)
            {
               _loc6_ = "${poster_" + _loc4_.extras + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_852)
            {
            ...
            var_320.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_463);
            var_320.show();
         }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            updateItemList(var_36.ownUserId);
         }
         _loc5_ = var_36.otherUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         while(_loc3_ < _loc5_.length)
         {
         ...
         if(_loc6_)
         {
            updateItemList(var_36.otherUserId);
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_36.otherUserItems.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_165)
            {
               var_165.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_165.stop();
               var_165 = null;
            }
            if(var_320 != null)
      ...
      protected function resolveItemThumbnail(param1:GroupItem) : BitmapData
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc3_ = _roomEngine.getWallItemIcon(param1.type,this,param1.extras);
            }
            if(_loc3_.id > 0)
            {
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc9_:* = param1 == var_36.otherUserId;
         var _loc10_:Map = !!_loc9_ ? var_36.otherUserItems : var_36.ownUserItems;
      ...
      {
         if(param2.type == WindowEvent.const_197)
         {
            param1.dispose();
         }
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1385 == null)
         {
            var_1385 = createMinimizedWindow();
         }
         if(!var_1756)
         {
            return var_67;
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_36.ownUserItems.length)
         {
            _loc2_ = var_36.ownUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_36.getFurniInventoryModel().displayItemInfo(_loc2_);
            }
         }
      }
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,othersThumbEventProc);
            _loc6_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_36.otherUserItems.length)
         {
            _loc2_ = var_36.otherUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_36.getFurniInventoryModel().displayItemInfo(_loc2_);
      ...
      public function startConfirmCountdown() : void
      {
         if(var_165 == null)
         {
            var_165 = new Timer(1000,3);
            var_165.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_165.reset();
         var_165.repeatCount = 3;
         var_165.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_67)
         {
            ...
            if(_loc2_)
            {
               _loc2_.text = var_36.otherUserName;
            }
            _loc1_ = var_67.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_738) : uint(const_739);
            }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_67)
         {
            ...
            switch(var_36.state)
            {
               case TradingModel.const_153:
                  if(var_36.otherUserItems.length > 0 || var_36.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
               ...
               case TradingModel.const_232:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_434:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_198:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
