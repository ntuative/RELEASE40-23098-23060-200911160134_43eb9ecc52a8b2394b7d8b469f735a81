package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_41:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_28 = param1;
         var_41 = var_28.communication;
         var_41.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_41.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_41.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_41.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_41.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_41.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_41.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_41.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_41.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_41.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_41.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_41.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_41.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_41.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_41.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_41.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_41.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_41.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_41.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_41.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_41.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_41.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_41.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_41.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_41.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_41.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_41.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_41.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_41.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_41.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_41.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_41.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_41.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
      }
      ...
      private function onPetRemoved(param1:PetRemovedFromInventoryEvent) : void
      {
         ...
         var _loc3_:PetsModel = var_28.petsModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FurniModel = var_28.furniModel;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_79,false);
      }
      ...
      {
         var _loc2_:EffectsModel = var_28.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_28.notifyChangedEffects();
      }
      
      private function onTradingAccepted(param1:IMessageEvent) : void
      {
         var _loc2_:TradingModel = var_28.tradingModel;
         if(_loc2_ != null)
         {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_585);
         _loc2_.refreshViews();
         var_28.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = var_28.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_154)
            {
               _loc8_ = String(_loc7_) + "poster" + _loc9_.itemSpecificData;
            }
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_40,_loc9_.category,_loc9_.itemSpecificData);
                  _loc3_.add(_loc8_,_loc6_);
               }
               _loc6_.push(new FloorItem(_loc9_.itemID,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,_loc9_.itemSpecificData,_loc9_.timeToExpiration,_loc9_.creationDay,_loc9_.creationMonth,_loc9_.creationYear,null,_loc9_.songID));
            }
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_41,_loc9_.category,_loc9_.itemSpecificData);
                  _loc3_.add(_loc8_,_loc6_);
               }
               _loc6_.push(new WallItem(_loc9_.itemID,_loc9_.itemTypeID,_loc9_.roomItemID,_loc9_.category,true,true,true,_loc9_.itemSpecificData));
            }
            _loc10_++;
         }
         ...
         var _loc12_:TradingModel = var_28.tradingModel;
         if(_loc12_ != null)
         {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            var_28.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember);
            var_28.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = var_28.badgesModel;
         if(_loc3_ != null)
         {
            _loc3_.updateBadge(_loc2_.badgeID,false);
            _loc3_.removeBadge(_loc2_.removedBadgeID);
         }
         var _loc4_:AchievementsModel = var_28.achievementsModel;
         if(_loc4_ != null)
         {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_41.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_219);
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != var_28.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = var_28.badgesModel;
      ...
      {
         var_28.creditBalance = (param1 as CreditBalanceEvent).getParser().balance;
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_28.setInventoryCategoryInit(InventoryCategory.const_279);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_79);
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.stuffData,_loc6_.expiryTime,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
                  ...
                  _loc5_ = new WallItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.stuffData);
               }
               if(_loc7_.length == 0)
               {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = var_28.sessionData;
         var _loc3_:IRoomSession = var_28.roomSession;
         if(_loc3_ == null)
         {
            return;
         }
         var_28.toggleInventorySubPage(InventorySubCategory.const_259);
         var _loc4_:TradingOpenEvent = param1 as TradingOpenEvent;
         var _loc5_:int = _loc4_.userID;
         var _loc6_:String = _loc3_.userDataManager.method_1(_loc5_).name;
         var _loc7_:* = _loc4_.userCanTrade > 0;
         var _loc8_:int = _loc4_.otherUserID;
         var _loc9_:String = _loc3_.userDataManager.method_1(_loc8_).name;
         ...
         var _loc11_:TradingModel = var_28.tradingModel;
         if(_loc11_ != null)
         {
      ...
      {
         var _loc2_:PetsModel = var_28.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_28.setInventoryCategoryInit(InventoryCategory.const_245);
      }
      
      public function onPixelBalance(param1:IMessageEvent) : void
      {
         var_28.pixelBalance = (param1 as HabboActivityPointNotificationMessageEvent).amount;
      }
