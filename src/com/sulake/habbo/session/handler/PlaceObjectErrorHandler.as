package com.sulake.habbo.session.handler
{
   ...
   public class PlaceObjectErrorHandler extends BaseHandler
   {
      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         {
            case PlaceObjectErrorEnum.const_187:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_212:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_211:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_155:
               _loc4_ = "null";
               break;
            ...
            case PlaceObjectErrorEnum.const_184:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_185:
               _loc4_ = "null";
               break;
            default:
               return;
