package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1153:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_908:String = "group_badge";
       
      
      private const const_1354:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1354,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1354 + param1;
         ...
         switch(param2)
         {
            case const_1153:
               if(var_178 != null)
               {
                  _loc5_ = var_178.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_908:
               if(var_178 != null)
               {
                  if(var_178 != null)
                  {
                     _loc5_ = var_178.getKey("group.badge.url");
