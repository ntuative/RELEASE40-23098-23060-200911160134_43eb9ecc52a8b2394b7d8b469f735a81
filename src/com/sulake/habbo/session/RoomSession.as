package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_983:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_287 && _connection != null)
         {
            _state = RoomSessionEvent.const_87;
            if(isPrivateRoom)
            {
      ...
      {
         return var_983 as IUserDataManager;
      }
