package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1463:UserTagManager;
      ...
      private var var_1462:GroupDetailsView;
      ...
      private var var_1228:Dictionary;
      ...
      private var var_827:IgnoredUsersManager;
      
      private var var_776:Dictionary;
      ...
      private var var_989:ProductDataParser;
      
      private var var_178:IHabboConfigurationManager;
      
      private var var_988:HabboGroupInfoManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_669 = [];
         var_1463 = new UserTagManager(events);
         var_988 = new HabboGroupInfoManager(this,events);
         var_827 = new IgnoredUsersManager(this);
      ...
      {
         var_989.removeEventListener(ProductDataParser.const_128,onProductsReady);
         var_989 = null;
         var_1228 = new Dictionary();
         ...
         var_990 = new FurnitureDataParser(_loc2_,var_1228,_furnitureIds,_localization);
         var_990.addEventListener(FurnitureDataParser.const_128,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1463.getTags(param1);
      }
      ...
      {
         var_776 = new Dictionary();
         var _loc2_:String = var_178.getKey("productdata.load.url");
         var _loc3_:String = var_178.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_989 = new ProductDataParser(_loc2_,var_776);
         var_989.addEventListener(ProductDataParser.const_128,onProductsReady);
      }
      ...
      {
         return var_988.getBadgeId(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         var_827.unignoreUser(param1);
      }
      ...
      {
         return var_1229.getBadgeImage(param1,BadgeImageManager.const_908);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _id = _loc3_.id;
         _name = _loc3_.name;
         var_1754 = _loc3_.respectTotal;
         _respectLeft = _loc3_.respectLeft;
         var_828 = _loc3_.petRespectLeft;
         var_540 = _loc3_.figure;
         _gender = _loc3_.sex;
         var_1226 = _loc3_.realName;
         var_827.initIgnoreList();
      ...
      {
         return var_988.getGroupDetails(param1);
      }
      ...
      {
         return var_827.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_2015 = _loc2_.isOpen;
         var_2014 = _loc2_.onShutDown;
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1462 == null)
         {
            var_1462 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_988.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1462.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_990.removeEventListener(FurnitureDataParser.const_128,onFurnitureReady);
         var_990 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_828 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_540 = _loc2_.figure;
            _gender = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_540));
         }
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1463.communication = _communication;
         var_988.communication = _communication;
         var_827.registerMessageEvents();
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1229 = new BadgeImageManager(_loc1_,events,var_178,_localization);
      }
