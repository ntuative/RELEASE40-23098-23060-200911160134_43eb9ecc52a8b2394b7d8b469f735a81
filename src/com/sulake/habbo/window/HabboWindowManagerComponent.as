package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_337:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1074:uint = 1;
      ...
      private var var_1197:ProfilerAgentTask;
      
      private var var_1196:IEventDispatcher;
      
      private var var_2232:uint = 0;
      
      private var var_1195:ProfilerAgentTask;
      
      private var var_1198:ProfilerOutput;
      
      private var var_653:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_185 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1196 = Component(param1).events;
            var_810 = new Array();
      ...
      {
         return var_295[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_295[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_653 = new WindowRenderer(_loc4_);
         var_295 = new Array(const_337);
         var _loc6_:int = 0;
         while(_loc6_ < const_337)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_653,this,_localization,var_185,new Rectangle(0,0,var_185.stageWidth,var_185.stageHeight),this);
            var_295[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_404 = var_295[const_1074];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_404.getMouseCursor().defineCustomCursorType(MouseCursorType.const_313,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_404.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1168,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_295[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_295.pop()).dispose();
            }
            if(var_1198 != null)
            {
               var_1198.dispose();
      ...
      {
         return var_295[param1].getDesktopWindow().getChildAt(var_404.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1198 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1198 = new ProfilerOutput(_loc3_,this,var_653);
               var_1197 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1197);
               var_1195 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1195);
               var_977 = true;
            }
         }
      }
      ...
      {
         return var_404.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_850.length > 0)
         {
            var_1196.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_337 - 1;
            while(_loc2_ >= 0)
            {
               var_295[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_977)
         ...
         var_1196.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_337)
         {
            var_295[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_977)
         {
         ...
         if(WindowContext.var_850.length > 0)
         {
            WindowContext.var_850.flush();
         }
         if(WindowContext.var_1272.length > 0)
         {
            WindowContext.var_1272.flush();
         }
         var_1196.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_810[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_810[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_404.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1182,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1120,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1273,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1167,param2.name + ": " + param2.toString());
            }
         }
      }
   }
