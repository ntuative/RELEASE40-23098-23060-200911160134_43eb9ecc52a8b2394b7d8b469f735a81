package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements ICoreUpdateReceiver
   {
      ...
      public static const const_678:int = 70;
      
      private static const const_736:int = 2;
      
      public static const const_467:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1113 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1113 = 15;
         }
         var_1384 = _window.height;
         var_514 = 4;
         var_372 = 0;
         _state = const_332;
         var_187 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1113;
         if(_window.height < var_1384)
         {
            _window.height = var_1384;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(_state)
         {
            ...
            case const_350:
               var_747 += param1;
               _loc2_ = Number(var_747) / Number(var_371["time_fade_in"]);
               if(var_747 > int(var_371["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_736:
               var_935 += param1;
               if(var_935 > int(var_371["time_display"]) && !var_1114)
               {
                  startFadeOut();
               }
               break;
            case const_735:
               var_748 += param1;
               _loc3_ = 1 - Number(var_748) / Number(var_371["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_748 > int(var_371["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_187.orientation == "TOP" ? int(const_331) : 0;
         var _loc4_:int = var_187.orientation == "BOTTOM" ? int(_loc2_.height - const_331) : int(_loc2_.height);
         var _loc5_:int = var_187.orientation == "LEFT" ? int(const_331) : 0;
         var _loc6_:int = var_187.orientation == "RIGHT" ? int(_loc2_.width - const_331) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_467;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_467;
            }
         }
         else if(false)
         {
         ...
         if(false)
         {
            if(false)
            {
               _window.y = _loc3_ + var_514;
            }
            else
            {
               _window.y = _loc4_ - 0 - var_514;
            }
         }
         else if(false)
         {
