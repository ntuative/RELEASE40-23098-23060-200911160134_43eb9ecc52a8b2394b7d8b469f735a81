package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1094:String = "badges";
      
      private static const const_1091:String = "pixelbalance";
      
      private static const const_1092:String = "credits";
      
      private static const const_1090:String = "inventory";
      
      private static const const_1088:String = "friendlist";
      
      private static const const_1093:String = "selectfurni";
      
      private static const const_1089:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_565:ParkBusDialogManager;
      
      private var var_1256:IHabboToolbar;
      
      private var var_564:HabboNotificationViewManager;
      ...
      private var var_204:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_843);
         }
         var _loc6_:Map = var_843["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_204 == null)
         {
            return;
         }
         var_204.handleUserBannedMessage(_loc2_.message);
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1101);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_880)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1184);
         }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_204.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_204.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1233);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2056)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_854);
            var_2056 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1219.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_37,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_48).clone();
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_841,_loc5_);
         }
      }
      ...
      {
         if(var_564.isSpaceAvailable() && false)
         {
            var_564.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_565 == null)
         {
            var_565 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_565 != null)
         {
            var_565.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1001.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1219.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BitmapData = var_520.getBadgeImage(_loc2_.badgeID);
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1191,_loc4_);
         }
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_197 || param2.type == WindowEvent.const_539)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_520.getProductData(_loc15_.productType);
               _loc17_ = var_520.getFurnitureData(_loc15_.furniClassId);
               _loc7_ = var_520.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_854,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1219.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_48,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_48);
         }
         if(param3 == "")
         {
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_204.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null) : int
      {
         ...
         var_1001.push(_loc7_);
         return var_1001.length;
      }
      ...
      {
         var_1256 = IHabboToolbar(param2);
         var_1256.events.addEventListener(HabboToolbarEvent.const_77,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_179);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_204 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_520.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_815);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_815);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_77)
         {
            ...
            var_564 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_843["styles"],var_843["view"],var_1256);
            ...
            registerUpdateReceiver(var_564,1);
            registerUpdateReceiver(this,2);
            var_520.events.addEventListener(BadgeImageReadyEvent.const_149,onBadgeImage);
            var_1256.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_204.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_285;
            }
            if(param2 == 3002)
            {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_276;
            }
            return 1;
         }
         return 1;
