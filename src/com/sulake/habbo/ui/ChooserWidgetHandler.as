package com.sulake.habbo.ui
{
   ...
   public class ChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function ChooserWidgetHandler()
      {
         super();
      }
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_397,_loc3_));
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_319);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_446);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_500);
         return _loc1_;
      }
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc2_:int = _container.roomSession.roomCategory;
         var _loc3_:* = [];
         var _loc9_:int = _container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = _container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_280);
               _loc6_ = _container.sessionDataManager.getFurnitureData(_loc5_);
               if(_loc6_ != null)
               {
                  _loc7_ = _loc6_.title;
               }
         ...
         _loc3_.sort(compareItems);
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_415,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_446:
               handleFurniChooserRequest();
               break;
            case RoomWidgetRequestWidgetMessage.const_319:
               handleUserChooserRequest();
               break;
            case RoomWidgetRoomObjectMessage.const_500:
      ...
      {
         return RoomWidgetEnum.const_239;
      }
   }
}
