package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_800:Number = 0;
      
      private var var_466:Point = null;
      
      private var var_644:Map = null;
      ...
      {
         return [RoomSessionChatEvent.const_145];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_468.length)
            {
               _loc2_ = var_468.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_145:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_468.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_644.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_295:
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_48).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_468.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_644.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_602,RoomWidgetChatSelectAvatarMessage.const_661];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_602:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_145,_container.roomSession,0,"Version 23098-23060-200911160109");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_319);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_446);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_800 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_800);
            }
            if(var_466 == null)
            {
               var_467.x = 0;
               var_467.y = 0;
               var_467.z = 0;
               var_466 = _loc4_.getScreenPoint(var_467);
               var_800 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_467.x = 0;
            var_467.y = 0;
            var_467.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_467);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_466.x || _loc8_.y != var_466.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_466,_loc5_));
