package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_71,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_608,RoomWidgetEcotronBoxOpenMessage.const_686,RoomWidgetEcotronBoxOpenedMessage.const_1113];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_231:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     _loc4_ = _container.sessionDataManager.getFurnitureData(_loc2_.classId);
                     if(_loc4_ != null)
                     {
                        _name = _loc4_.title;
                     }
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_71,0,_name,false,_loc3_.data);
      ...
      {
         return RoomWidgetEnum.const_356;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_608:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc8_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_57,_loc2_.id,_loc6_,_loc7_);
                     _container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_686:
