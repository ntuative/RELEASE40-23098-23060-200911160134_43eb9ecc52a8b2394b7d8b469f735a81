   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_142,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_149,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_144,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_133,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_142,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_149,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_144,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_133,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_501);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_280);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_295)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_402)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_901)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_506);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_207)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_180)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_619);
                     _loc11_.hasFlatControl = _loc28_ == "furniture" || _loc28_ == "useradmin" || _loc28_ == "";
                     _loc11_.canBeKicked = _loc28_ != "useradmin" && _container.roomSession.isPrivateRoom;
                  }
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1142;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_889;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_873;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1335);
               }
               else
               {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.setDirection(AvatarSetType.const_37,4);
                  _loc11_.image = _loc16_.getImage(AvatarSetType.const_37);
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc3_:IUserData = _container.roomSession.userDataManager.method_1(_loc2_.petId);
         if(_loc3_ == null)
         {
            return;
         }
         var _loc4_:String = _loc3_.figure;
         var _loc5_:IAvatarImage = var_548.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_548.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            _loc13_ = _container.roomSession.userDataManager.method_1(_loc2_.ownerId);
            if(_loc13_ != null)
            {
               _loc14_ = _container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_33);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_619);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_116];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_293);
         _loc1_.push(RoomWidgetUserActionMessage.const_562);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_492);
         _loc1_.push(RoomWidgetUserActionMessage.const_559);
         _loc1_.push(RoomWidgetUserActionMessage.const_611);
         _loc1_.push(RoomWidgetUserActionMessage.const_667);
         _loc1_.push(RoomWidgetFurniActionMessage.const_243);
         _loc1_.push(RoomWidgetFurniActionMessage.const_712);
         _loc1_.push(RoomWidgetFurniActionMessage.const_548);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_605);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_537);
         _loc1_.push(RoomWidgetUserActionMessage.const_439);
         _loc1_.push(RoomWidgetUserActionMessage.const_604);
         _loc1_.push(RoomWidgetUserActionMessage.const_680);
         _loc1_.push(RoomWidgetUserActionMessage.const_1339);
         _loc1_.push(RoomWidgetPetCommandMessage.const_706);
         _loc1_.push(RoomWidgetPetCommandMessage.const_529);
         _loc1_.push(RoomWidgetUserActionMessage.const_600);
         _loc1_.push(RoomWidgetUserActionMessage.const_640);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_116:
      ...
      public function dispose() : void
      {
         ...
         if(var_548 != null)
         {
            _loc1_ = var_548.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_548.getValue(_loc2_);
               _loc3_.dispose();
               _loc3_ = null;
            }
            var_548 = null;
      ...
      {
         return RoomWidgetEnum.const_343;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc3_ = _container.roomSession.userDataManager.method_1(_loc2_);
            }
            if(_loc3_ == null)
            {
               return null;
         ...
         if(_loc7_ != null)
         {
            ...
            _loc6_ = _loc7_.method_9;
         }
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_293:
               return handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_562:
            ...
            case RoomWidgetUserActionMessage.const_581:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_803,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_628:
               ...
               break;
            case RoomWidgetUserActionMessage.const_492:
               _container.roomSession.assignRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_559:
               _container.roomSession.removeRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_611:
               _loc9_ = _container.roomSession.userDataManager.method_1(_loc4_.userId);
               _container.inventory.setupTrading(_loc9_.id,_loc9_.name);
               break;
            case RoomWidgetUserActionMessage.const_667:
            ...
            case RoomWidgetUserActionMessage.const_680:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_712:
            ...
            case RoomWidgetRoomTagSearchMessage.const_605:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_537:
            ...
            case RoomWidgetUserActionMessage.const_439:
               ...
               break;
            case RoomWidgetUserActionMessage.const_604:
