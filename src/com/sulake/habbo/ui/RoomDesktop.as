package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_231:DesktopLayoutManager;
      ...
      private var var_1218:Boolean = true;
      
      private var _widgets:Map;
      
      private var var_1773:IHabboHelp = null;
      ...
      private var var_755:IRoomWidgetFactory = null;
      ...
      private var var_1219:IAvatarRenderManager = null;
      ...
      private var var_520:ISessionDataManager = null;
      
      private var var_1983:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_230 = new Map();
         var_231 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_423,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_388,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_626,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_665 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_447 != null && true)
         {
            var_1218 = !var_447.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_267[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_230.length)
            {
               _loc5_ = var_230.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_423,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_388,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_626,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_755 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1983);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_230.length)
         {
            _loc2_ = var_230.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_231.setLayout(param1,_windowManager);
         if(var_187 != null)
         {
            var_231.toolbarSize = var_187.size;
            var_231.toolbarOrientation = var_187.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_755.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_231.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_230.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_231.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_231 != null)
         {
            var_231.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_112:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_575,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_109:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_494,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_117:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_601,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_440:
               handleRoomAdClick(param1);
               break;
            case RoomEngineObjectEvent.const_368:
            case RoomEngineObjectEvent.const_361:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_230.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_231.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_594);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_561);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_530);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_669);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_248,canvasMouseHandler);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_47 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_196);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_368:
               ...
               var_174 = _windowManager.createWindow("room_ad_tooltip","${ads.roomad.tooltip}",WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_217,WindowParam.const_85) as IToolTipWindow;
               var_174.setParamFlag(WindowParam.const_47,false);
      ...
      {
         if(var_665 == null || false)
         {
            return;
         }
         var _loc2_:int = var_665.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_34 != null && var_47 != null && var_1218 && var_9)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_231.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
