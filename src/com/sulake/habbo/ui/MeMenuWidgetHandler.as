   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_834,HabboToolbarIconEnum.MEMENU);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_90:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_90));
               break;
            case HabboHelpTutorialEvent.const_470:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_408));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_711,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_470,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_90,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_711,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_914,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_536,onHabboClubSubscriptionChanged);
         }
         var_187 = _container.toolbar;
         if(var_187)
         {
            var_187.events.addEventListener(HabboToolbarEvent.const_77,onHabboToolbarEvent);
            var_187.events.addEventListener(HabboToolbarEvent.const_56,onHabboToolbarEvent);
            setMeMenuToolbarIcon(false);
         }
         if(false)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_470,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_90,onHelpTutorialEvent);
         }
         var_80 = _container.catalog;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_532);
         _loc1_.push(RoomWidgetDanceMessage.const_675);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_607);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_535);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_584);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_593);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_662);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_489);
         _loc1_.push(RoomWidgetStopEffectMessage.const_637);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1110);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_953);
         _loc1_.push(RoomWidgetToolbarMessage.const_635);
         _loc1_.push(RoomWidgetToolbarMessage.const_512);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_522);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1344);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_784);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_690);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_544);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_541);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_643);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1276);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_538);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_720);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_697));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_544:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetWaveMessage.const_532:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_675:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_607:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_535:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_584:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_489:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_80 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_609)
               {
                  var_80.openCatalogPage(CatalogPageName.const_272,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_662:
               ...
               if(var_28 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_849:
                        var_80.openCatalogPage(CatalogPageName.const_1302,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_879:
                        var_28.toggleInventoryPage(InventoryCategory.const_245);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1152:
                        var_28.toggleInventoryPage(InventoryCategory.const_79);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1334:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_637:
            ...
            case RoomWidgetNavigateToRoomMessage.const_953:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_690:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_635:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_187)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_43,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               if(false)
               {
                  ...
                  _loc16_ = _container.roomSession.userDataManager.method_1(_loc15_);
                  _loc17_ = 0;
                  _loc18_ = 0;
                  _container.roomEngine.selectAvatar(_loc17_,_loc18_,_loc16_.id,true);
               }
               break;
            case RoomWidgetToolbarMessage.const_512:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(var_187)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_386,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_522:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_457,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_930));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_457,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1249));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_541:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_643:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_304,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_538:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_304,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_720:
