package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function RoomInstance(param1:String, param2:IRoomInstanceContainer)
      {
         ...
         _container = param2;
         _id = param1;
         var_418 = new Dictionary();
         var_420 = new Dictionary();
         var_880 = [];
         var_879 = [];
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_209.getValue(_loc2_) != null)
         {
            _loc3_ = var_209.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_420[param1] != param2)
         {
            var_420[param1] = param2;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < var_209.length)
            {
               _loc3_ = var_209.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_418 != null)
         {
            for(_loc1_ in var_418)
            {
               delete var_418[_loc1_];
            }
            var_418 = null;
         }
         if(var_420 != null)
         {
            for(_loc1_ in var_420)
            {
               delete var_420[_loc1_];
            }
            var_420 = null;
         }
         var_879 = [];
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_125 != null)
            {
               var_125.feedRoomObject(_loc5_,String(param3));
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            if(var_125)
            {
               var_125.removeRoomObject(param1,String(param2));
            }
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         if(var_418[param1] != param2)
         {
            var_418[param1] = param2;
         }
      }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  var_125.feedRoomObject(_loc7_,String(_loc4_));
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_209.getValue(_loc2_) != null)
         {
            return var_209.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_209.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_209.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_125)
                  {
                     var_125.removeRoomObject(_loc6_,String(param1));
                  }
               }
               _loc4_++;
            }
