package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_564:int = -1;
      
      public static const const_927:int = 2;
      
      public static const const_1099:int = 0;
      ...
      private var var_727:XML = null;
      
      private var _state:int = 0;
      
      private var var_114:IRoomManagerListener;
      ...
      private var var_431:IRoomObjectFactory = null;
      
      private var var_1304:int;
      
      private var var_2222:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_430 = [];
         var_422 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_423,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_388,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_626,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(_state == const_1099)
         {
            if(var_727 != null)
            {
               return false;
         ...
         var_1304 = 50;
         var_114 = param2;
         var _loc3_:Array = var_50.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(var_430.indexOf(_loc5_) < 0)
            {
               var_50.loadObjectContent(_loc5_,_events);
               var_430.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!var_50.hasInternalContent(param3))
         {
            _loc7_ = var_50.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               var_50.loadObjectContent(param3,_events);
               _loc12_ = var_50.getPlaceHolderType(param3);
               _loc7_ = var_50.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = var_50.getVisualizationXML(_loc12_);
            _loc9_ = var_50.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = var_50.getVisualizationType(_loc12_);
            _loc11_ = var_50.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_362.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_362.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_431.createRoomObjectLogic(_loc11_);
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(var_50 != null)
         {
            if(var_50.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_431 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_422.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_422.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_431 != null)
         {
            return var_431.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(var_114 != null)
            {
               var_114.contentLoaded(null,false);
            }
            return;
         }
         var _loc3_:XML = var_50.getVisualizationXML(_loc2_);
         if(_loc3_ == null)
         {
            if(var_114 != null)
            {
               var_114.contentLoaded(_loc2_,false);
            }
            return;
         }
         var _loc4_:IGraphicAssetCollection = var_50.getGraphicAssetCollection(_loc2_);
         if(_loc4_ == null)
         {
            if(var_114 != null)
            {
         ...
         if(var_114 != null)
         {
            var_114.contentLoaded(_loc2_,true);
         }
         if(false)
         {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_50.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(false)
            {
               ...
               if(var_114 != null)
               {
                  var_114.roomManagerInitialized();
               }
            }
         }
         else
         {
            _state = const_564;
            var_114.roomManagerInitialized(false);
         }
      }
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(var_50 == null || var_362 == null)
         {
            return;
         }
         var _loc2_:XML = var_50.getVisualizationXML(param1);
         var _loc3_:XML = var_50.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = var_50.getGraphicAssetCollection(param1);
               ...
               while(_loc10_ >= 0)
               {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        _loc16_ = var_50.getContentType(_loc15_);
                        if(_loc16_ == param1)
                        {
                           _loc17_ = var_50.getVisualizationType(_loc15_);
                           _loc18_ = var_50.getLogicType(_loc15_);
                           _loc5_ = var_362.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_362.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_431.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(var_114 != null)
                                 {
                                    var_114.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
