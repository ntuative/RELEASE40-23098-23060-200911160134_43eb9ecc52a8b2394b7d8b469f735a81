package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_556:Number = 64;
      
      public static const const_838:Number = 32;
      ...
      private var var_367:Number = 1;
      
      private var _y:Vector3d;
      
      private var var_1362:Number = 1;
      
      private var var_82:int = 0;
      
      private var var_364:Map = null;
      
      private var var_918:Vector3d;
      ...
      private var var_1363:Number = 1;
      
      private var var_2206:Number = 500;
      
      private var var_1361:Number = 1;
      
      private var var_90:Vector3d;
      
      private var var_89:Vector3d;
      
      private var var_2205:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_89 = new Vector3d();
         var_918 = new Vector3d();
         var_1362 = 1;
         var_1361 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1363 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_216.assign(param1);
         if(var_216.x != _loc2_ || var_216.y != _loc3_ || var_216.z != _loc4_)
         {
            ++var_82;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            var_90.assign(_loc23_);
            _y.assign(_loc24_);
            var_89.assign(_loc25_);
         }
         else
         {
            var_90.assign(_loc18_);
            _y.assign(_loc19_);
      ...
      {
         if(var_367 != param1 * var_1363)
         {
            var_367 = param1 * var_1363;
            ++var_82;
         }
      }
      ...
      {
         if(var_365 != param1 * var_1362)
         {
            var_365 = param1 * var_1362;
            ++var_82;
         }
      }
      ...
      {
         if(var_366 != param1 * var_1361)
         {
            var_366 = param1 * var_1361;
            ++var_82;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_364 != null)
         {
            ...
            var_364.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_364.add(_loc3_,_loc4_);
            ++var_82;
         }
      }
      ...
      {
         return new Vector3d(var_216.x,var_216.y,var_216.z);
      }
      
      public function method_2(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_918.assign(_loc22_);
         }
         else
         {
            var_918.assign(_loc17_);
         }
         ++var_82;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_366;
         _loc2_.z *= var_367;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_918);
         if(_loc3_ < var_2205 || _loc3_ > var_2206)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,var_90);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_366;
            _loc2_.z *= var_367;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_918);
         }
      ...
      {
         return new Vector3d(0 * var_365,0 * var_366,0 * var_367);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.scalarProjection(param1,var_90);
      ...
      {
         return scale == const_556;
      }
      
      public function get scale() : Number
      {
         return var_199 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_364 != null)
         {
            ...
            return var_364.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_199;
         var _loc6_:Number = -param1.y / var_199;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_90,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_365,0 * var_366,0 * var_367);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_365,param2.y * var_366,param2.z * var_367);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_365,param3.y * var_366,param3.z * var_367);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_365,param4.y * var_366,param4.z * var_367);
